  ...
  module Bi
    module V20220105
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::bi::V20220105::ModifyResourceUserRequest`
        # @rtype: :class:`Tencentcloud::bi::V20220105::ModifyResourceUserResponse`
        def ModifyResourceUser(request)
          body = send_request('ModifyResourceUser', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ModifyResourceUserResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
