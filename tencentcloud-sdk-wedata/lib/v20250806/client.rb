  ...
  module Wedata
    module V20250806
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::wedata::V20250806::CreateTriggerWorkflowRunRequest`
        # @rtype: :class:`Tencentcloud::wedata::V20250806::CreateTriggerWorkflowRunResponse`
        def CreateTriggerWorkflowRun(request)
          body = send_request('CreateTriggerWorkflowRun', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateTriggerWorkflowRunResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::wedata::V20250806::ListTriggerTaskRunsRequest`
        # @rtype: :class:`Tencentcloud::wedata::V20250806::ListTriggerTaskRunsResponse`
        def ListTriggerTaskRuns(request)
          body = send_request('ListTriggerTaskRuns', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ListTriggerTaskRunsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
