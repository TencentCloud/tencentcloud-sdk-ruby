  ...
  module Sms
    module V20210111
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::sms::V20210111::DescribeSendRecordListRequest`
        # @rtype: :class:`Tencentcloud::sms::V20210111::DescribeSendRecordListResponse`
        def DescribeSendRecordList(request)
          body = send_request('DescribeSendRecordList', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeSendRecordListResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::sms::V20210111::SendMultiGlobalSmsRequest`
        # @rtype: :class:`Tencentcloud::sms::V20210111::SendMultiGlobalSmsResponse`
        def SendMultiGlobalSms(request)
          body = send_request('SendMultiGlobalSms', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = SendMultiGlobalSmsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
