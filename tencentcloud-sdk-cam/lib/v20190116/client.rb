  ...
  module Cam
    module V20190116
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::cam::V20190116::CreateSubAccountLoginIpPolicyRequest`
        # @rtype: :class:`Tencentcloud::cam::V20190116::CreateSubAccountLoginIpPolicyResponse`
        def CreateSubAccountLoginIpPolicy(request)
          body = send_request('CreateSubAccountLoginIpPolicy', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateSubAccountLoginIpPolicyResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::cam::V20190116::ListAccountsRequest`
        # @rtype: :class:`Tencentcloud::cam::V20190116::ListAccountsResponse`
        def ListAccounts(request)
          body = send_request('ListAccounts', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ListAccountsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
