  ...
  module Bm
    module V20180423
      ...
      class DeviceHardwareInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceId, :IsElastic, :CpmPayMode, :CpuId, :Mem, :ContainRaidCard, :SystemDiskTypeId, :SystemDiskCount, :DataDiskTypeId, :DataDiskCount, :CpuDescription, :MemDescription, :DiskDescription, :NicDescription, :RaidDescription, :Cpu
        
        def initialize(instanceid=nil, iselastic=nil, cpmpaymode=nil, cpuid=nil, mem=nil, containraidcard=nil, systemdisktypeid=nil, systemdiskcount=nil, datadisktypeid=nil, datadiskcount=nil, cpudescription=nil, memdescription=nil, diskdescription=nil, nicdescription=nil, raiddescription=nil, cpu=nil)
          @InstanceId = instanceid
          @IsElastic = iselastic
          @CpmPayMode = cpmpaymode
          @CpuId = cpuid
