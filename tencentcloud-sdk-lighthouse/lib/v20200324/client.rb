  ...
  module Lighthouse
    module V20200324
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::lighthouse::V20200324::DescribeBlueprintsShareAcrossAccountInfosRequest`
        # @rtype: :class:`Tencentcloud::lighthouse::V20200324::DescribeBlueprintsShareAcrossAccountInfosResponse`
        def DescribeBlueprintsShareAcrossAccountInfos(request)
          body = send_request('DescribeBlueprintsShareAcrossAccountInfos', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeBlueprintsShareAcrossAccountInfosResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
