  ...
  module Cdwch
    module V20200915
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::cdwch::V20200915::DescribeEventTasksRequest`
        # @rtype: :class:`Tencentcloud::cdwch::V20200915::DescribeEventTasksResponse`
        def DescribeEventTasks(request)
          body = send_request('DescribeEventTasks', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeEventTasksResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
