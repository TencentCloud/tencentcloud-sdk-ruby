  ...
  module Essbasic
    module V20210526
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @param request: Request instance for CancelOrganizationFlows.
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CancelOrganizationFlowsRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::CancelOrganizationFlowsResponse`
        def CancelOrganizationFlows(request)
          body = send_request('CancelOrganizationFlows', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CancelOrganizationFlowsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::ChannelRenewAutoSignLicenseRequest`
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreateBatchAdminChangeInvitationsRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::CreateBatchAdminChangeInvitationsResponse`
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreateBatchAdminChangeInvitationsUrlRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::CreateBatchAdminChangeInvitationsUrlResponse`
        ...
        # @param request: Request instance for CreateFileConvertTask.
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreateFileConvertTaskRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::CreateFileConvertTaskResponse`
        def CreateFileConvertTask(request)
          body = send_request('CreateFileConvertTask', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateFileConvertTaskResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreateFlowGroupSignReviewRequest`
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreatePersonAuthCertificateImageRequest`
        ...
        # @param request: Request instance for CreateRequestWithEncryption.
        # @type request: :class:`Tencentcloud::essbasic::V20210526::CreateRequestWithEncryptionRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::CreateRequestWithEncryptionResponse`
        def CreateRequestWithEncryption(request)
          body = send_request('CreateRequestWithEncryption', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateRequestWithEncryptionResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @param request: Request instance for DescribeFileConvertTask.
        # @type request: :class:`Tencentcloud::essbasic::V20210526::DescribeFileConvertTaskRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::DescribeFileConvertTaskResponse`
        def DescribeFileConvertTask(request)
          body = send_request('DescribeFileConvertTask', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeFileConvertTaskResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::ModifyFlowDeadlineRequest`
        ...
        # @type request: :class:`Tencentcloud::essbasic::V20210526::ModifyOrganizationBusinessInfoRequest`
        # @rtype: :class:`Tencentcloud::essbasic::V20210526::ModifyOrganizationBusinessInfoResponse`
        def ModifyOrganizationBusinessInfo(request)
          body = send_request('ModifyOrganizationBusinessInfo', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ModifyOrganizationBusinessInfoResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
