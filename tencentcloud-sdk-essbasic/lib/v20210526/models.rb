  ...
  module Essbasic
    module V20210526
      ...
      class Agent < TencentCloud::Common::AbstractModel
        ...
        deprecate :ProxyOrganizationId, :none, 2026, 9
        deprecate :ProxyOrganizationId=, :none, 2026, 9
      ...
      class ApproverOption < TencentCloud::Common::AbstractModel
        ...
        # @param FillType: <p>签署人信息补充类型，默认无需补充。<ul><li> <strong>1</strong> :  动态签署人（可发起合同后再补充签署人信息）注：<code>企业“授权签”不支持动态补充</code></li></ul>注：<code>使用动态签署人能力前，需登录腾讯电子签控制台打开服务开关</code></p><p>枚举值：</p><ul><li>1： 动态签署人</li></ul>
        ...
        # @param ApproverMobileMode: <p>签署人手机号传参模式</p><p>枚举值：</p><ul><li>REPLACE： 接受已有认证手机号并替换</li><li>GIVEN： 以客户入参输入手机号为主</li><li>VALIDATE： 若与认证手机号不一致则报错</li><li>&quot;&quot;： 不走手机号传参模式</li></ul><p>默认值：&quot;&quot;</p><p>会触发手机号传参模式的前提是：签署人是指定了具体身份信息的</p><ul><li>渠道方签署人不会触发</li><li>非渠道方签署人在指定签署人姓名，证件号的情况下会触发</li></ul>
        ...
        attr_accessor :NoRefuse, :NoTransfer, :HideOneKeySign, :FillType, :FlowReadLimit, :ForbidAddSignDate, :ApproverMobileMode, :AddSignComponentUseSealSize

        def initialize(norefuse=nil, notransfer=nil, hideonekeysign=nil, filltype=nil, flowreadlimit=nil, forbidaddsigndate=nil, approvermobilemode=nil, addsigncomponentusesealsize=nil)
          @NoRefuse = norefuse
      ...
      class AutoSignConfig < TencentCloud::Common::AbstractModel
        ...
        # @param LicenseType: <p>设置用户开通“授权签”时是否绑定个人“授权签”账号许可。<ul><li><b>1</b>: (默认)不绑定“授权签”账号许可开通，开通后一直有效,   后续使用合同份额进行合同发起</li></ul>注：<code>该字段已经失效，请勿设置此参数。</code></p>
      ...
      class CancelOrganizationFlowsRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Agent, :CancelMessage, :CancelMessageFormat

        def initialize(agent=nil, cancelmessage=nil, cancelmessageformat=nil)
          @Agent = agent
      ...
      class ChannelCreateBatchQuickSignUrlRequest < TencentCloud::Common::AbstractModel
        ...
        # @param PresetApproverInfo: <p>预设的动态签署方的补充信息，仅匹配对应信息的签署方才能领取合同。若为个人动态签署方，支持预设姓名、证件、手机号。若为企业员工动态签署方，仅支持预设企业名称（仅限预设SaaS企业参与方，不支持子客企业）。</p>
      ...
      class ChannelCreateDynamicFlowApproverRequest < TencentCloud::Common::AbstractModel
        # @param FillDynamicFlowList: <p>动态合同信息</p>
      ...
      class ChannelCreateEmbedWebUrlRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :HiddenComponents, :none, 2026, 9
        deprecate :HiddenComponents=, :none, 2026, 9
        deprecate :Operator, :none, 2026, 9
        deprecate :Operator=, :none, 2026, 9
      ...
      class ChannelCreateEmbedWebUrlResponse < TencentCloud::Common::AbstractModel
        # @param WebUrl: <p>嵌入的web链接，5分钟有效</p>
        # @type WebUrl: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class ChannelCreateFlowByFilesRequest < TencentCloud::Common::AbstractModel
        ...
        # @param AutoSignScene: <p>个人授权签名的使用场景包括以下, 个人授权签署(即ApproverType设置成个人授权签署时)业务此值必传：</p><ul><li> **E_PRESCRIPTION_AUTO_SIGN**：电子处方单（医疗授权签）  </li><li> **OTHER** :  通用场景</li></ul>注: <code>个人授权签名场景是白名单功能，使用前请与对接的客户经理联系沟通。</code>
        # @type AutoSignScene: String
        # @param Operator: <p>操作者的信息，不用传</p>
        # @type Operator: :class:`Tencentcloud::Essbasic.v20210526.models.UserInfo`
        # @param FlowDisplayType: <p>在短信通知、填写、签署流程中，若标题、按钮、合同详情等地方存在“合同”字样时，可根据此配置指定文案，可选文案如下：  <ul><li> <b>0</b> :合同（默认值）</li> <li> <b>1</b> :文件</li> <li> <b>2</b> :协议</li><li> <b>3</b> :文书</li></ul>效果如下:<img src="https://qcloudimg.tencent-cloud.cn/raw/e4a2c4d638717cc901d3dbd5137c9bbc.png" alt="FlowDisplayType"></p>
        # @type FlowDisplayType: Integer
        # @param NeedPreview: <p>是否为预览模式，取值如下： <ul><li> <strong>false</strong>：非预览模式（默认），会产生合同流程并返回合同流程编号FlowId。</li> <li> <strong>true</strong>：预览模式，不产生合同流程，不返回合同流程编号FlowId，而是返回预览链接PreviewUrl，有效期为300秒，用于查看真实发起后合同的样子。</li></ul></p><p><strong>注</strong>: 预览服务按照合同份额 1:2的比例赠送预览次数。例如：购买 100 份合同，将赠送 200 次合同预览额度。当赠送的预览额度使用完后，如需继续使用预览服务，则需要单独购买预览服务额度。</p>
        ...
        deprecate :Operator, :none, 2026, 9
        deprecate :Operator=, :none, 2026, 9
        deprecate :OpenDynamicFlow, :none, 2026, 9
        deprecate :OpenDynamicFlow=, :none, 2026, 9
      ...
      class ChannelCreateMultiFlowSignQRCodeRequest < TencentCloud::Common::AbstractModel
        ...
        # @param FlowDisplayType: <p>在短信通知、填写、签署流程中，若标题、按钮、合同详情等地方存在“合同”字样时，可根据此配置指定文案，可选文案如下： </p><p>枚举值：</p><ul><li>0： 合同</li><li>1： 文件</li><li>2： 协议</li><li>3： 文书</li></ul><p>默认值：0</p><p>效果如下:<br><img src="https://qcloudimg.tencent-cloud.cn/raw/e4a2c4d638717cc901d3dbd5137c9bbc.png" alt="FlowDisplayType"></p>
        # @type FlowDisplayType: Integer
        ...
        attr_accessor :Agent, :TemplateId, :FlowName, :MaxFlowNum, :FlowEffectiveDay, :FlowDisplayType, :QrEffectiveDay, :Restrictions, :ApproverComponentLimitTypes, :CallbackUrl, :ApproverRestrictions, :Operator, :ForbidPersonalMultipleSign, :FlowNameAppendScannerInfo, :QrCodeName, :QrCodeExpiredOn
        extend Gem::Deprecate
        ...
        def initialize(agent=nil, templateid=nil, flowname=nil, maxflownum=nil, floweffectiveday=nil, flowdisplaytype=nil, qreffectiveday=nil, restrictions=nil, approvercomponentlimittypes=nil, callbackurl=nil, approverrestrictions=nil, operator=nil, forbidpersonalmultiplesign=nil, flownameappendscannerinfo=nil, qrcodename=nil, qrcodeexpiredon=nil)
          @Agent = agent
      ...
      class ChannelCreatePrepareFlowGroupRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :BaseFlowInfos, :FlowGroupName, :ResourceType, :Agent, :FlowGroupOptions, :FlowGroupType, :FlowGroupDeadline

        def initialize(baseflowinfos=nil, flowgroupname=nil, resourcetype=nil, agent=nil, flowgroupoptions=nil, flowgrouptype=nil, flowgroupdeadline=nil)
      ...
      class ChannelCreatePrepareFlowRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :FlowApproverList, :none, 2026, 9
        deprecate :FlowApproverList=, :none, 2026, 9
        deprecate :NeedPreview, :none, 2026, 9
        deprecate :NeedPreview=, :none, 2026, 9
        deprecate :Organization, :none, 2026, 9
        deprecate :Organization=, :none, 2026, 9
        deprecate :Operator, :none, 2026, 9
      ...
      class ChannelCreatePreparedPersonalEsignRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Agent, :UserName, :IdCardNumber, :SealName, :Operator, :IdCardType, :Mobile, :FileId, :SceneKey, :LicenseType, :SealImage, :EnableAutoSign, :SealImageCompress
        extend Gem::Deprecate
        ...
        def initialize(agent=nil, username=nil, idcardnumber=nil, sealname=nil, operator=nil, idcardtype=nil, mobile=nil, fileid=nil, scenekey=nil, licensetype=nil, sealimage=nil, enableautosign=nil, sealimagecompress=nil)
          @Agent = agent
          @UserName = username
          @IdCardNumber = idcardnumber
          @SealName = sealname
      ...
      class ChannelCreateUserAutoSignEnableUrlRequest < TencentCloud::Common::AbstractModel
        ...
        # @param Operator: <p>执行本接口操作的员工信息。<br>注: <code>在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。</code></p>
        # @type Operator: :class:`Tencentcloud::Essbasic.v20210526.models.UserInfo`
        # @param AutoSignConfig: <p>授权签开通配置信息, 包括开通的人员的信息等</p>
        ...
        # @type ExpiredTime: Integer
        # @param UserData: <p>调用方自定义的个性化字段(可自定义此字段的值)，并以base64方式编码，支持的最大数据大小为 20480长度。 在个人授权签的开通、关闭等回调信息场景中，该字段的信息将原封不动地透传给贵方。</p>
        # @type UserData: String
      ...
      class ChannelCreateUserAutoSignEnableUrlResponse < TencentCloud::Common::AbstractModel
        # @param Url: <p>个人用户授权签的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>
        # @type Url: String
      ...
      class ChannelDescribeUserAutoSignStatusResponse < TencentCloud::Common::AbstractModel
        # @param IsOpen: <p>查询用户是否已开通授权签</p>
        # @type IsOpen: Boolean
        # @param LicenseFrom: <p>授权签许可生效时间。当且仅当已通过许可开通授权签时有值。</p><p>值为unix时间戳,单位为秒。</p>
        # @type LicenseFrom: Integer
        # @param LicenseTo: <p>授权签许可到期时间。当且仅当已通过许可开通授权签时有值。</p><p>值为unix时间戳,单位为秒。</p>
        # @type LicenseTo: Integer
        # @param LicenseType: <p>设置用户开通授权签时是否绑定个人授权签账号许可。</p><p>枚举值：</p><ul><li>0： 使用个人授权签账号许可进行开通，个人授权签账号许可有效期1年，注: <code>不可解绑释放更换他人</code></li><li>1： 不绑定授权签账号许可开通，后续使用合同份额进行合同发起</li></ul>
        # @type LicenseType: Integer
        # @param SealId: <p>用户开通授权签指定使用的印章，为空则未设置印章，需重新进入开通链接设置印章。</p>
        # @type SealId: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class ChannelDisableUserAutoSignRequest < TencentCloud::Common::AbstractModel
        ...
        # @param SceneKey: <p>授权签使用的场景值, 可以选择的场景值如下:</p><p>枚举值：</p><ul><li>E_PRESCRIPTION_AUTO_SIGN： 电子处方场景</li><li>OTHER： 通用场景</li></ul>
        # @type SceneKey: String
        # @param UserInfo: <p>需要关闭授权签的个人的信息，如姓名，证件信息等。</p>
        # @type UserInfo: :class:`Tencentcloud::Essbasic.v20210526.models.UserThreeFactor`
        # @param Operator: <p>执行本接口操作的员工信息。<br>注: <code>在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。</code></p>
        # @type Operator: :class:`Tencentcloud::Essbasic.v20210526.models.UserInfo`
      ...
      class ChannelOrganizationInfo < TencentCloud::Common::AbstractModel
        ...
        # @type HasSubmittedAuthInfo: Boolean

        attr_accessor :OrganizationId, :OrganizationOpenId, :OrganizationName, :UnifiedSocialCreditCode, :LegalName, :LegalOpenId, :AdminName, :AdminOpenId, :AdminMobile, :AuthorizationStatus, :AuthorizationType, :ActiveStatus, :LicenseExpireTime, :HasSubmittedAuthInfo

        def initialize(organizationid=nil, organizationopenid=nil, organizationname=nil, unifiedsocialcreditcode=nil, legalname=nil, legalopenid=nil, adminname=nil, adminopenid=nil, adminmobile=nil, authorizationstatus=nil, authorizationtype=nil, activestatus=nil, licenseexpiretime=nil, hassubmittedauthinfo=nil)
          ...
          @HasSubmittedAuthInfo = hassubmittedauthinfo
        end
        ...
        def deserialize(params)
          ...
          @HasSubmittedAuthInfo = params['HasSubmittedAuthInfo']
        end
      end
      ...
      class CommonApproverOption < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CanEditApprover, :NoRefuse, :NoTransfer, :HideOneKeySign, :FlowReadLimit, :ForbidAddSignDate, :ForbidModifySealInfos

        def initialize(caneditapprover=nil, norefuse=nil, notransfer=nil, hideonekeysign=nil, flowreadlimit=nil, forbidaddsigndate=nil, forbidmodifysealinfos=nil)
      ...
      class CommonFlowApprover < TencentCloud::Common::AbstractModel
        ...
        # @param ApproverIdCardType: <p>签署方经办人的证件类型，支持以下类型</p><ul><li>ID_CARD : 中国大陆居民身份证  (默认值)</li><li>HONGKONG_AND_MACAO : 中国港澳居民来往内地通行证</li><li>HONGKONG_MACAO_AND_TAIWAN : 中国港澳台居民居住证(格式同中国大陆居民身份证)</li></ul>
        ...
        attr_accessor :NotChannelOrganization, :ApproverType, :OrganizationId, :OrganizationOpenId, :OrganizationName, :UserId, :OpenId, :ApproverName, :ApproverMobile, :ApproverIdCardType, :ApproverIdCardNumber, :RecipientId, :PreReadTime, :IsFullText, :NotifyType, :ApproverOption, :SignComponents, :ApproverVerifyTypes, :ApproverSignTypes, :ComponentLimitType

        def initialize(notchannelorganization=nil, approvertype=nil, organizationid=nil, organizationopenid=nil, organizationname=nil, userid=nil, openid=nil, approvername=nil, approvermobile=nil, approveridcardtype=nil, approveridcardnumber=nil, recipientid=nil, prereadtime=nil, isfulltext=nil, notifytype=nil, approveroption=nil, signcomponents=nil, approververifytypes=nil, approversigntypes=nil, componentlimittype=nil)
      ...
      class CreateBatchInitOrganizationUrlResponse < TencentCloud::Common::AbstractModel
        # @param MiniAppPath: <p>小程序路径，有效时间为7天</p>
        # @type MiniAppPath: String
        # @param OperateLongUrl: <p>操作长链，有效时间为7天</p>
        # @type OperateLongUrl: String
        # @param OperateShortUrl: <p>操作短链，有效时间为7天</p>
        # @type OperateShortUrl: String
        # @param QRCodeUrl: <p>操作二维码，有效时间为7天</p>
        # @type QRCodeUrl: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class CreateConsoleLoginUrlRequest < TencentCloud::Common::AbstractModel
        ...
        # @type Agent: :class:`Tencentcloud::Essbasic.v20210526.models.Agent`
        # @param ProxyOrganizationName: <p>第三方平台子客的企业名称，请确认该企业名称与企业营业执照中注册的名称完全一致。<br><font color="red"><br>在测试环境联调的过程中，企业名称请统一加上“测试”二字，如：典子谦示例企业测试，否则将无法审核通过。<br>企业名称请使用以下名称, 以下名称可以不用走收录。<br><strong>子客测试专用企业1 - 子客测试专用企业9</strong></font></p><p>注:<br> <code>1. 如果名称中包含英文括号()，请使用中文括号（）代替。</code><br> <code>2、该名称需要与Agent.ProxyOrganizationOpenId相匹配,  企业激活后Agent.ProxyOrganizationOpenId会跟此企业名称一一绑定; 如果您的企业已经在认证授权中或者激活完成，这里修改子客企业名字将不会生效。</code></p>
        # @type ProxyOrganizationName: String
        # @param UniformSocialCreditCode: <p>子客企业统一社会信用代码，最大长度200个字符<br>注意：<code>如果您的企业已经在认证授权中或者激活完成，这里修改子客企业名字将不会生效</code>。</p>
        # @type UniformSocialCreditCode: String
        # @param ProxyOperatorName: <p>子客企业员工的姓名，最大长度50个字符,  员工的姓名将用于身份认证和电子签名，请确保填写的姓名为签署方的真实姓名，而非昵称等代名。</p><p>注：<code>该姓名需要和Agent.ProxyOperator.OpenId相匹配,  当员工完成认证后该姓名会和Agent.ProxyOperator.OpenId一一绑定, 若员工已认证加入企业，这里修改经办人名字传入将不会生效</code></p>
        # @type ProxyOperatorName: String
        # @param ProxyOperatorMobile: <p>子客企业员工的手机码,  支持国内手机号11位数字(无需加+86前缀或其他字符)。注：<code>该手机号需要和Agent.ProxyOperator.OpenId相匹配,  当员工完成认证后该手机号会和Agent.ProxyOperator.OpenId一一绑定, 若员工已认证加入企业，这里修改经办人手机号传入将不会生效</code></p>
        # @type ProxyOperatorMobile: String
        # @param Module: <p>Web控制台登录后进入的功能模块,  支持的模块包括：</p><ul><li> **空值** :(默认)企业中心模块</li><li> **DOCUMENT** :合同管理模块</li><li> **TEMPLATE** :企业模板管理模块</li><li> **SEAL** :印章管理模块</li><li> **OPERATOR** :组织管理模块</li></ul>注意：1、如果EndPoint选择"CHANNEL"或"APP"，该参数仅支持传递"SEAL"，进入印章管理模块2、该参数**仅在企业和员工激活已经完成，登录控制台场景才生效**。
        # @type Module: String
        # @param ModuleId: <p>该参数和Module参数配合使用，用于指定模块下的资源Id，指定后链接登录将展示该资源的详情。</p><p>根据Module参数的不同所代表的含义不同(ModuleId需要和Module对应，ModuleId可以通过API或者控制台获取到)。当前支持：</p><table> <thead> <tr> <th>Module传值</th> <th>ModuleId传值</th> <th>进入的目标页面</th> </tr> </thead> <tbody> <tr> <td>SEAL</td> <td>印章ID</td> <td>查看指定印章的详情页面</td> </tr> <tr> <td>TEMPLATE</td> <td>合同模板ID</td> <td>指定模板的详情页面</td> </tr> <tr> <td>DOCUMENT</td> <td>合同ID</td> <td>指定合同的详情页面</td> </tr> </tbody> </table>注意：该参数**仅在企业和员工激活完成，登录控制台场景才生效**。
        # @type ModuleId: String
        # @param MenuStatus: <p>是否展示左侧菜单栏 </p><ul><li> **ENABLE** : (默认)进入web控制台展示左侧菜单栏</li><li> **DISABLE** : 进入web控制台不展示左侧菜单栏</li></ul>注：该参数**仅在企业和员工激活完成，登录控制台场景才生效**。
        # @type MenuStatus: String
        # @param Endpoint: <p>生成链接的类型：</p><ul><li>**PC**：(默认)<font color="red">web控制台</font>链接, 需要在PC浏览器中打开</li><li>**CHANNEL**：H5跳转到电子签小程序链接, 一般用于发送短信中带的链接, 打开后进入腾讯电子签小程序</li><li>**SHORT_URL**：<font color="red">H5</font>跳转到电子签小程序链接的短链形式, 一般用于发送短信中带的链接, 打开后进入腾讯电子签小程序</li><li>**WEIXIN_QRCODE_URL**：直接跳转至电子签小程序的二维码链接，无需通过中转页。<font color="red">您需要自行将其转换为二维码，使用微信扫码后可直接进入。请注意，直接点击链接是无效的。</font></li><li>**APP**：<font color="red">APP或小程序</font>跳转电子签小程序链接, 一般用于贵方小程序或者APP跳转过来,  打开后进入腾讯电子签小程序</li><li>**H5**：<font color="red">H5长链接</font>跳转H5链接, 一般用于贵方H5跳转过来,  打开后进入腾讯电子签H5页面</li><li>**SHORT_H5**：<font color="red">H5短链</font>跳转H5的短链形式, 一般用于发送短信中带的链接, 打开后进入腾讯电子签H5页面</li></ul>
        # @type Endpoint: String
        # @param AutoJumpBackEvent: <p><font color="red">已废弃</font> 请使用 JumpEvents 参数，进行替换。<br>触发自动跳转事件，仅对EndPoint为App类型有效，可选值包括：</p><ul><li> **VERIFIED** :企业认证完成/员工认证完成后跳回原App/小程序</li></ul>
        # @type AutoJumpBackEvent: String
        # @param AuthorizationTypes: <p>可选的此企业允许的授权方式, 可以设置的方式有:</p><ul><li>2：转法定代表人授权</li><li>5：授权书+对公打款</li></ul>
        # @type AuthorizationTypes: Array
        # @param ProxyOperatorIdCardNumber: <p>子客经办人身份证<br>注意：<code>如果已同步，这里非空会更新同步的经办人身份证号，暂时只支持中国大陆居民身份证类型</code>。</p>
        # @type ProxyOperatorIdCardNumber: String
        # @param AutoJumpUrl: <p><font color="red">已废弃</font> 请使用 JumpEvents 参数，进行替换。<br>认证完成跳转链接。<br>注意：<code>此功能仅在Endpoint参数设置成 H5 或 PC时才有效</code>。</p>
        # @type AutoJumpUrl: String
        # @param TopNavigationStatus: <p>是否展示头顶导航栏  <ul><li> <strong>ENABLE</strong> : (默认)进入web控制台展示头顶导航栏</li> <li> <strong>DISABLE</strong> : 进入web控制台不展示头顶导航栏</li></ul> 注：该参数<strong>仅在企业和员工激活完成，登录控制台场景才生效</strong>。</p><p><a href="https://qcloudimg.tencent-cloud.cn/raw/dd54f333140c711cf6a88e3801bcd178.png" target="_blank">点击查看头顶导航栏位置</a></p>
        # @type TopNavigationStatus: String
        # @param AutoActive: <p>是否自动激活子客企业，有下面两种选项：</p><p><strong>false（默认设置）</strong>：不自动激活子客户。您需要通过控制台或调用<a href="https://qian.tencent.com/developers/partnerApis/accounts/CreateChannelSubOrganizationActive">激活或者续期子企业</a>接口手动完成激活过程。</p><p><strong>true</strong>：若持有的许可证充足，子客户企业注册完成后将自动激活，无需手动操作或访问控制台。</p><p><b>注</b>：如果<b>应用扩展服务</b>中的<b>自动激活子客企业</b>为打开态， 则忽略本接口的AutoActive这个参数（若持有的许可证充足，子客户企业注册完成后将自动激活），具体位置参考下图：<br><img src="https://qcloudimg.tencent-cloud.cn/raw/c3639b05503d3735bac483d17aa6b0a3.png" alt="image"></p>
        ...
        # @param ProxyLegalName: <p>组织机构法人的姓名。 请确认该企业统一社会信用代码与企业营业执照中注册的法人姓名一致。</p>
        # @type ProxyLegalName: String
        # @param PowerOfAttorneys: <p>授权书(PNG或JPG或PDF) base64格式, 大小不超过8M 。<br> p.s. 如果上传授权书 ，需遵循以下条件 </p><ol><li>超管的信息（超管姓名，超管手机号）必须为必填参数。 </li><li>认证方式AuthorizationTypes必须只能是上传授权书方式</li></ol>
        # @type PowerOfAttorneys: Array
        # @param OrganizationAuthorizationOptions: <p>企业认证时个性化能力信息</p>
        # @type OrganizationAuthorizationOptions: :class:`Tencentcloud::Essbasic.v20210526.models.OrganizationAuthorizationOptions`
        # @param BankAccountNumber: <p>组织机构对公打款 账号，账户名跟企业名称一致。</p><p>p.s.<br>只有认证方式是授权书+对公打款时才生效。</p>
        # @type BankAccountNumber: String
        # @param Operator: <p>无</p>
        # @type Operator: :class:`Tencentcloud::Essbasic.v20210526.models.UserInfo`
        # @param JumpEvents: <p>跳转事件，其中包括认证期间收录，授权书审核，企业认证的回跳事件。<br>p.s.Endpoint如果是APP 类型，请传递JumpUrl为<font color="red">&quot;true&quot; </font><br>如果 Endpoint 是 H5 类型，请参考文档跳转电子签H5 p.s. 如果Endpoint是 APP，传递的跳转地址无效，不会进行跳转，仅会进行回跳。</p>
        # @type JumpEvents: Array
        # @param ProxyOrganizationIdCardType: <p>企业证照类型：</p><ul><li> **USCC** :(默认)工商组织营业执照</li><li> **PRACTICELICENSEOFMEDICALINSTITUTION** :医疗机构执业许可证</li><li> **CLINICFILLINGCERTIFICATE* :诊所备案证</li></ul><p>枚举值：</p><ul><li>USCC： 工商组织营业执照</li><li>PRACTICELICENSEOFMEDICALINSTITUTION： 医疗机构执业许可证</li><li>CLINICFILLINGCERTIFICATE： 诊所备案证</li></ul>
      ...
      class CreateFlowOption < TencentCloud::Common::AbstractModel
        ...
        # @param ForbidEditApprover: <p>是否可以编辑签署人包括新增，修改，删除 <ul><li>（默认） false -可以编辑签署人</li> <li> true - 禁止编辑签署人</li></ul>注意：* 如果设置参数为 true， 则 参数签署人 <a href="https://qian.tencent.com/developers/partnerApis/embedPages/ChannelCreatePrepareFlow">FlowApproverList</a> 不能为空* 此参数对子客和“授权签”无效，不允许进行修改。</p>
      ...
      class CreatePartnerAutoSignAuthUrlRequest < TencentCloud::Common::AbstractModel
        ...
        # @param PlatformAppAuthorization: <p>是否给平台应用授权</p><ul><li><strong>true</strong>: 表示是，授权平台应用。在此情况下，无需设置<code>AuthorizedOrganizationIds</code>和<code>AuthorizedOrganizationNames</code>。</li><li><strong>false</strong>: （默认）表示否，不是授权平台应用。</li></ul><p> 注：授权给平台应用需要开通【基于子客授权第三方应用可文件发起子客授权签署】白名单，请联系运营经理开通。</p>
        ...
        extend Gem::Deprecate
        deprecate :AuthorizedOrganizationId, :none, 2026, 9
        deprecate :AuthorizedOrganizationId=, :none, 2026, 9
        deprecate :AuthorizedOrganizationName, :none, 2026, 9
        deprecate :AuthorizedOrganizationName=, :none, 2026, 9
      ...
      class CreatePersonAuthCertificateImageRequest < TencentCloud::Common::AbstractModel
        ...
        # @type UserName: String
        # @param IdCardType: <p>证件类型，支持以下类型<ul><li> ID_CARD  : 中国大陆居民身份证 (默认值)</li><li> HONGKONG_AND_MACAO  : 中国港澳居民来往内地通行证</li><li> HONGKONG_MACAO_AND_TAIWAN  : 中国港澳台居民居住证(格式同中国大陆居民身份证)</li></ul></p>
        # @type IdCardType: String
        # @param IdCardNumber: <p>证件号码，应符合以下规则<ul><li>居民身份证号码应为18位字符串，由数字和大写字母X组成（如存在X，请大写）。</li><li>港澳居民来往内地通行证号码共11位。第1位为字母，“H”字头签发给中国香港居民，“M”字头签发给中国澳门居民；第2位至第11位为数字。</li><li>港澳台居民居住证号码编码规则与中国大陆身份证相同，应为18位字符串。</li></ul></p>
        # @type IdCardNumber: String
        # @param SceneKey: <p>授权使用的场景值, 可以选择的场景值如下:</p><p>枚举值：</p><ul><li>E_PRESCRIPTION_AUTO_SIGN： 电子处方场景</li><li>OTHER： 通用场景</li></ul><p>默认值：E_PRESCRIPTION_AUTO_SIGN</p><p>注: <code>不传默认为处方单场景，即E_PRESCRIPTION_AUTO_SIGN</code></p>
        # @type SceneKey: String
      ...
      class CreatePersonAuthCertificateImageResponse < TencentCloud::Common::AbstractModel
        ...
        # @param ImageCertId: <p>个人用户认证证书的编号, 为20位数字组成的字符串,  由腾讯电子签下发此编号 。该编号会合成到个人用户证书证明图片。注: <code>个人用户认证证书的编号和证明图片绑定, 获取新的证明图片编号会变动</code></p>
        ...
        # @param ValidFrom: <p>CA证书颁发时间，格式为Unix标准时间戳（秒）   该时间格式化后会合成到个人用户证书证明图片</p>
        # @type ValidFrom: Integer
        # @param ValidTo: <p>CA证书有效截止时间，格式为Unix标准时间戳（秒）该时间格式化后会合成到个人用户证书证明图片</p>
      ...
      class CreateRequestWithEncryptionRequest < TencentCloud::Common::AbstractModel
        ...
        # @param ApplicationId: <p>第三方应用的唯一标识，对应通用参数 Agent.AppId。</p>
        ...
        attr_accessor :RequestAction, :ApplicationId, :IV, :EncryptedData, :EncryptionSignature

        def initialize(requestaction=nil, applicationid=nil, iv=nil, encrypteddata=nil, encryptionsignature=nil)
      ...
      class CreateSealByImageRequest < TencentCloud::Common::AbstractModel
        ...
        # @param SealName: <p>电子印章名字，1-50个中文字符<br>注:<code>同一企业下电子印章名字不能相同</code></p>
        # @type SealName: String
        # @param SealImage: <p>电子印章图片base64编码，大小不超过10M（原始图片不超过5M），只支持PNG或JPG图片格式</p><p>注: <code>通过图片创建的电子印章，需电子签平台人工审核</code></p>
        # @type SealImage: String
        ...
        # @param TaxIdentifyCode: <p>企业税号</p><p>注:</p><ul><li>1.印章类型SealType是INVOICE类型时，此参数才会生效</li><li>2.印章类型SealType是INVOICE类型，且该字段没有传入值或传入空时，会取该企业对应的统一社会信用代码作为默认的企业税号（<font color="red">如果是通过授权书授权方式认证的企业，此参数必传不能为空</font>）</li></ul>
        ...
        attr_accessor :Agent, :SealName, :SealImage, :Operator, :GenerateSource, :SealType, :SealHorizontalText, :SealStyle, :SubSealType, :SealSize, :TaxIdentifyCode, :SealDescription, :Options
        extend Gem::Deprecate
        deprecate :Operator, :none, 2026, 9
        deprecate :Operator=, :none, 2026, 9

        def initialize(agent=nil, sealname=nil, sealimage=nil, operator=nil, generatesource=nil, sealtype=nil, sealhorizontaltext=nil, sealstyle=nil, subsealtype=nil, sealsize=nil, taxidentifycode=nil, sealdescription=nil, options=nil)
          @Agent = agent
          @SealName = sealname
          @SealImage = sealimage
          @Operator = operator
      ...
      class CreateSealByImageResponse < TencentCloud::Common::AbstractModel
        # @param SealId: <p>电子印章ID，为32位字符串。<br>建议开发者保留此印章ID，后续指定签署区印章或者操作印章需此印章ID。</p>
        # @type SealId: String
        # @param ImageUrl: <p>电子印章预览链接地址，地址默认失效时间为24小时。</p><p>注:<code>图片上传生成的电子印章无预览链接地址</code></p>
      ...
      class DescribeExtendedServiceAuthDetailResponse < TencentCloud::Common::AbstractModel
        # @param AuthInfoDetail: <p>服务授权的信息列表，根据查询类型返回特定扩展服务的开通和授权状况。</p>
      ...
      class DescribeTemplatesRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Agent, :TemplateId, :ContentType, :TemplateIds, :Limit, :Offset, :TemplateName, :ChannelTemplateId, :QueryAllComponents, :WithPreviewUrl, :ShowPreviewComponents, :WithPdfUrl, :Operator, :UserFlowTypeId
        extend Gem::Deprecate
        deprecate :Operator, :none, 2026, 9
        deprecate :Operator=, :none, 2026, 9

        def initialize(agent=nil, templateid=nil, contenttype=nil, templateids=nil, limit=nil, offset=nil, templatename=nil, channeltemplateid=nil, queryallcomponents=nil, withpreviewurl=nil, showpreviewcomponents=nil, withpdfurl=nil, operator=nil, userflowtypeid=nil)
          @Agent = agent
          @TemplateId = templateid
      ...
      class FlowGroupOptions < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SelfOrganizationApproverSignEach, :OtherApproverSignEach, :NoEditFlowName, :NoEditFlowType, :NoEditDeadline, :SignComponentConfig, :ForbidEditWatermark, :HideSignCodeAfterStart, :SignAfterStart, :PreviewAfterStart

        def initialize(selforganizationapproversigneach=nil, otherapproversigneach=nil, noeditflowname=nil, noeditflowtype=nil, noeditdeadline=nil, signcomponentconfig=nil, forbideditwatermark=nil, hidesigncodeafterstart=nil, signafterstart=nil, previewafterstart=nil)
      ...
      class ModifyExtendedServiceRequest < TencentCloud::Common::AbstractModel
        # @param Agent: <p>关于渠道应用的相关信息，包括渠道应用标识、第三方平台子客企业标识及第三方平台子客企业中的员工标识等内容，您可以参阅开发者中心所提供的 Agent 结构体以获取详细定义。</p><p>此接口下面信息必填。</p><ul><li>渠道应用标识:  Agent.AppId</li><li>第三方平台子客企业标识: Agent.ProxyOrganizationOpenId</li><li>第三方平台子客企业中的员工标识: Agent.ProxyOperator.OpenId</li></ul>第三方平台子客企业和员工必须已经过实名认证
        # @type Agent: :class:`Tencentcloud::Essbasic.v20210526.models.Agent`
        # @param ServiceType: <p>扩展服务类型</p><p>枚举值：</p><ul><li>AUTO_SIGN： 企业授权签</li><li>OVERSEA_SIGN： 企业与港澳台居民签署合同</li><li>MOBILE_CHECK_APPROVER： 使用手机号验证签署方身份</li><li>DOWNLOAD_FLOW： 授权渠道下载合同</li><li>AGE_LIMIT_EXPANSION： 拓宽签署方年龄限制</li><li>HIDE_OPERATOR_DISPLAY： 隐藏合同经办人姓名</li></ul>
      ...
      class NeedReviewApproverInfo < TencentCloud::Common::AbstractModel
        ...
        # @type ApproverName: String
        # @param ApproverMobile: <p>签署方经办人手机号码， 支持国内手机号11位数字(无需加+86前缀或其他字符)。 请确认手机号所有方为此合同签署方。</p>
        # @type ApproverMobile: String
      ...
      class OrganizationAuthorizationOptions < TencentCloud::Common::AbstractModel
        ...
        # @param AddressSame: <p>对方打开链接认证时，公司地址是否要与接口传递上来的保持一致。</p><ul><li><b>false（默认值）</b>：关闭状态，实际认证时允许与接口传递的信息存在不一致。</li><li><b>true</b>：启用状态，实际认证时会回显接口传递的值，且不可更改</li></ul>p.s. 仅在公司地址（ProxyAddress）不为空时有效如下图所示：<img src="https://qcloudimg.tencent-cloud.cn/raw/4aa67a434cdf522c04e32f2e1de0382b.png" alt="示例"><p></p>
        ...
        attr_accessor :UniformSocialCreditCodeSame, :OrganizationNameSame, :LegalNameSame, :BankAccountNumberSame, :AddressSame, :BizLicenseSame

        def initialize(uniformsocialcreditcodesame=nil, organizationnamesame=nil, legalnamesame=nil, bankaccountnumbersame=nil, addresssame=nil, bizlicensesame=nil)
      ...
      class SignUrlInfo < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :CustomUserId, :none, 2026, 9
        deprecate :CustomUserId=, :none, 2026, 9
      ...
      class TemplateInfo < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :IsPromoter, :none, 2026, 9
        deprecate :IsPromoter=, :none, 2026, 9
      ...
      class UploadFilesRequest < TencentCloud::Common::AbstractModel
        # @param Agent: <p>关于渠道应用的相关信息，包括渠道应用标识、第三方平台子客企业标识及第三方平台子客企业中的员工标识等内容，您可以参阅开发者中心所提供的 Agent 结构体以获取详细定义。</p><p>此接口下面信息必填。</p><ul><li>渠道应用标识:  Agent.AppId</li><li>第三方平台子客企业标识: Agent.ProxyOrganizationOpenId</li><li>第三方平台子客企业中的员工标识: Agent. ProxyOperator.OpenId</li></ul>第三方平台子客企业和员工必须已经经过实名认证
        # @type Agent: :class:`Tencentcloud::Essbasic.v20210526.models.Agent`
        # @param BusinessType: <p>文件对应业务类型,可以选择的类型如下</p><p>枚举值：</p><ul><li>TEMPLATE： 此上传的文件用户生成合同模板，文件类型支持.pdf/.doc/.docx/.html格式，如果非pdf文件需要通过<a href="https://qian.tencent.com/developers/companyApis/templatesAndFiles/CreateConvertTaskApi" target="_blank">创建文件转换任务</a>转换后才能使用</li><li>DOCUMENT： 此文件用来发起合同流程，文件类型支持.pdf/.doc/.docx/.jpg/.png/.xls.xlsx/.html。如果上传的是非pdf文件，用来发起流程，还需要通过<a href="https://qian.tencent.com/developers/partnerApis/files/CreateFileConvertTask" target="_blank">创建文件转换任务</a>转换后得到的pdf文件才能用于发起合同接口。如果上传的文件不是用来发起合同，直接上传后使用返回的文件资源Id即可</li><li>SEAL：  此文件用于印章的生成，文件类型支持.jpg/.jpeg/.png</li><li>ARCHIVE： 此文件用于归档文件夹，文件类型支持.pdf/.zip格式</li><li>BUSINESSLICENSE： 此文件用于上传营业执照，用于后续<a href="https://qian.tencent.com/developers/partnerApis/accounts/CreateConsoleLoginUrl" target="_blank">生成子客登录链接</a>认证子客的时候提供营业执照，文件类型支持.jpg/.jpeg/.png，限制8M以内</li></ul>
