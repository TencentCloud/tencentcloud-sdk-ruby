  ...
  module Mps
    module V20190612
      ...
      class DescribeWorkflowsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @WorkflowInfoSet = params['WorkflowInfoSet']
          @RequestId = params['RequestId']
        end
      end
      ...
      class LiveStreamAiRecognitionResultItem < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @Type = params['Type']
          @FaceRecognitionResultSet = params['FaceRecognitionResultSet']
          @AsrWordsRecognitionResultSet = params['AsrWordsRecognitionResultSet']
          @OcrWordsRecognitionResultSet = params['OcrWordsRecognitionResultSet']
          @AsrFullTextRecognitionResultSet = params['AsrFullTextRecognitionResultSet']
          @OcrFullTextRecognitionResultSet = params['OcrFullTextRecognitionResultSet']
        end
      end
      ...
      class LiveStreamAiReviewResultItem < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @Type = params['Type']
          @ImagePornResultSet = params['ImagePornResultSet']
          @ImageTerrorismResultSet = params['ImageTerrorismResultSet']
          @ImagePoliticalResultSet = params['ImagePoliticalResultSet']
          @VoicePornResultSet = params['VoicePornResultSet']
        end
      end
