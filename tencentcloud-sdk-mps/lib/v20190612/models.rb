    ...
    module V20190612
      ...
      class LiveStreamAiQualityControlResultInfo < TencentCloud::Common::AbstractModel
        ...
        def initialize(qualitycontrolresults=nil, diagnoseresults=nil, qualitycontrolresultset=nil, diagnoseresultset=nil)
          ...
          @DiagnoseResultSet = diagnoseresultset
        end
        ...
        def deserialize(params)
          ...
          unless params['DiagnoseResultSet'].nil?
            @DiagnoseResultSet = []
            params['DiagnoseResultSet'].each do |i|
              diagnoseresult_tmp = DiagnoseResult.new
              diagnoseresult_tmp.deserialize(i)
              @DiagnoseResultSet << diagnoseresult_tmp
            end
          end
        end
      end
