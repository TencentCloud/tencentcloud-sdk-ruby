  ...
  module Cdwdoris
    module V20211228
      ...
      class DescribeAreaRegionResponse < TencentCloud::Common::AbstractModel
        ...
        # @type IsolationDays: Integer
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :Items, :FrontEndRules, :AvailableWhiteListNames, :IsolationDays, :RequestId

        def initialize(items=nil, frontendrules=nil, availablewhitelistnames=nil, isolationdays=nil, requestid=nil)
          @Items = items
        ...
        def deserialize(params)
          ...
          @IsolationDays = params['IsolationDays']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeClusterConfigsResponse < TencentCloud::Common::AbstractModel
        ...
        # @type IPDBFileSizeLimit: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :ClusterConfList, :BuildVersion, :ErrorMsg, :HasCN, :ExistingJarConfList, :IPDBFileSizeLimit, :RequestId

        def initialize(clusterconflist=nil, buildversion=nil, errormsg=nil, hascn=nil, existingjarconflist=nil, ipdbfilesizelimit=nil, requestid=nil)
          @ClusterConfList = clusterconflist
          @BuildVersion = buildversion
          @ErrorMsg = errormsg
          @HasCN = hascn
          @ExistingJarConfList = existingjarconflist
          @IPDBFileSizeLimit = ipdbfilesizelimit
          @RequestId = requestid
        end
        ...
        def deserialize(params)
          ...
          @IPDBFileSizeLimit = params['IPDBFileSizeLimit']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWorkloadGroupResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :WorkloadGroups, :Status, :ErrorMsg, :MonitorStatus, :RequestId

        def initialize(workloadgroups=nil, status=nil, errormsg=nil, monitorstatus=nil, requestid=nil)
      ...
      class InstanceInfo < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          @EnableSqlConv = params['EnableSqlConv']
      ...
      class SnapshotRemainPolicy < TencentCloud::Common::AbstractModel
        ...
        # 1：季度
        # 2：年
        # @type RemainDaysUnit: Integer

        attr_accessor :Type, :RemainDays, :RemainLatestNum, :RemainDaysUnit

        def initialize(type=nil, remaindays=nil, remainlatestnum=nil, remaindaysunit=nil)
          @Type = type
          @RemainDays = remaindays
          @RemainLatestNum = remainlatestnum
          @RemainDaysUnit = remaindaysunit
        end
        ...
        def deserialize(params)
          ...
          @RemainDaysUnit = params['RemainDaysUnit']
        end
      end
      ...
      class WorkloadGroupConfig < TencentCloud::Common::AbstractModel
        ...
        # @type MinCpuPercent: Integer
        # @param MinMemoryPercent: <p>4.1+ 新增；默认值为 0（不预留），根据业务可设为 5/10</p>
        # @type MinMemoryPercent: Integer
        # @param MaxConcurrencyNum: <p>2.1+ 新增；不传走内核默认（Integer.MAX_VALUE=2147483647），建议按业务并发量配置</p>
        # @type MaxConcurrencyNum: Integer
        # @param MaxQueueSize: <p>2.1+ 新增；0=不排队，建议为 MaxConcurrencyNum 的 50%</p>
        # @type MaxQueueSize: Integer
        # @param QueueTimeout: <p>2.1+ 新增；单位 ms，建议 5000（5s）</p>
        # @type QueueTimeout: Integer

        attr_accessor :WorkloadGroupName, :CpuShare, :MemoryLimit, :EnableMemoryOverCommit, :CpuHardLimit, :MinCpuPercent, :MinMemoryPercent, :MaxConcurrencyNum, :MaxQueueSize, :QueueTimeout

        def initialize(workloadgroupname=nil, cpushare=nil, memorylimit=nil, enablememoryovercommit=nil, cpuhardlimit=nil, mincpupercent=nil, minmemorypercent=nil, maxconcurrencynum=nil, maxqueuesize=nil, queuetimeout=nil)
          @WorkloadGroupName = workloadgroupname
          @CpuShare = cpushare
          ...
          @MinMemoryPercent = minmemorypercent
        ...
        def deserialize(params)
          ...
          @MinCpuPercent = params['MinCpuPercent']
          @MinMemoryPercent = params['MinMemoryPercent']
          @MaxConcurrencyNum = params['MaxConcurrencyNum']
