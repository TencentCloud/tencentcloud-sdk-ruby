  ...
  module Dsgc
    module V20190723
      ...
      class CreateDSPAAssessmentTaskRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :BusinessName, :none, 2025, 3
        deprecate :BusinessName=, :none, 2025, 3
        deprecate :BusinessDept, :none, 2025, 3
        deprecate :BusinessDept=, :none, 2025, 3
        deprecate :BusinessOwner, :none, 2025, 3
        deprecate :BusinessOwner=, :none, 2025, 3
      ...
      class CreateDSPACosMetaResourcesRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ResourceRegion, :none, 2025, 3
        deprecate :ResourceRegion=, :none, 2025, 3
        deprecate :Buckets, :none, 2025, 3
        deprecate :Buckets=, :none, 2025, 3
      ...
      class CreateDSPADbMetaResourcesRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :ResourceRegion, :none, 2025, 3
        deprecate :ResourceRegion=, :none, 2025, 3
        deprecate :UpdateStatus, :none, 2025, 3
        deprecate :UpdateStatus=, :none, 2025, 3
        deprecate :UpdateId, :none, 2025, 3
        deprecate :UpdateId=, :none, 2025, 3
        deprecate :Items, :none, 2025, 3
        deprecate :Items=, :none, 2025, 3
      ...
      class CreateDSPADiscoveryTaskRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :GeneralRuleSetEnable, :none, 2025, 3
        deprecate :GeneralRuleSetEnable=, :none, 2025, 3
      ...
      class DescribeBindDBListRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :DataSourceType, :none, 2025, 3
        deprecate :DataSourceType=, :none, 2025, 3
        deprecate :DataSourceId, :none, 2025, 3
        deprecate :DataSourceId=, :none, 2025, 3
      ...
      class ModifyDSPAAssessmentRiskLatestRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :RiskLatestTableId, :none, 2025, 3
        deprecate :RiskLatestTableId=, :none, 2025, 3
