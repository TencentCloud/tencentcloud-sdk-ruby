  ...
  module Tcbr
    module V20220217
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::tcbr::V20220217::SubmitServerConfigChangeDiffRequest`
        # @rtype: :class:`Tencentcloud::tcbr::V20220217::SubmitServerConfigChangeDiffResponse`
        def SubmitServerConfigChangeDiff(request)
          body = send_request('SubmitServerConfigChangeDiff', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = SubmitServerConfigChangeDiffResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
