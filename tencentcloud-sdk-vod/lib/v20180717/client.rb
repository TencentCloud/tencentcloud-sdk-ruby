  ...
  module Vod
    module V20180717
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::CreateAigcAdvancedCustomElementRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcAdvancedCustomElementResponse`
        def CreateAigcAdvancedCustomElement(request)
          body = send_request('CreateAigcAdvancedCustomElement', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAigcAdvancedCustomElementResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcAudioTaskResponse`
        ...
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcCustomVoiceResponse`
        def CreateAigcCustomVoice(request)
          body = send_request('CreateAigcCustomVoice', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAigcCustomVoiceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::CreateAigcQuotaRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcQuotaResponse`
        def CreateAigcQuota(request)
          body = send_request('CreateAigcQuota', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAigcQuotaResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::CreateAigcSubjectRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcSubjectResponse`
        def CreateAigcSubject(request)
          body = send_request('CreateAigcSubject', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAigcSubjectResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::CreateAigcVideoRedrawTaskRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::CreateAigcVideoRedrawTaskResponse`
        def CreateAigcVideoRedrawTask(request)
          body = send_request('CreateAigcVideoRedrawTask', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAigcVideoRedrawTaskResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::DeleteAigcAdvancedCustomElementRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::DeleteAigcAdvancedCustomElementResponse`
        def DeleteAigcAdvancedCustomElement(request)
          body = send_request('DeleteAigcAdvancedCustomElement', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DeleteAigcAdvancedCustomElementResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::DeleteAigcQuotaRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::DeleteAigcQuotaResponse`
        def DeleteAigcQuota(request)
          body = send_request('DeleteAigcQuota', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DeleteAigcQuotaResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::DescribeAigcAdvancedCustomElementsRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::DescribeAigcAdvancedCustomElementsResponse`
        def DescribeAigcAdvancedCustomElements(request)
          body = send_request('DescribeAigcAdvancedCustomElements', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeAigcAdvancedCustomElementsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::DescribeAigcQuotasRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::DescribeAigcQuotasResponse`
        def DescribeAigcQuotas(request)
          body = send_request('DescribeAigcQuotas', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeAigcQuotasResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::vod::V20180717::ModifyAigcQuotaRequest`
        # @rtype: :class:`Tencentcloud::vod::V20180717::ModifyAigcQuotaResponse`
        def ModifyAigcQuota(request)
          body = send_request('ModifyAigcQuota', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ModifyAigcQuotaResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
