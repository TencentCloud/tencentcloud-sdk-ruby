...
module TencentCloud
  module Vclm
    module V20240523
      # 控制摄像机运动的协议
      class CameraControl < TencentCloud::Common::AbstractModel
        ...
        def initialize(type=nil, config=nil)
          @Type = type
          @Config = config
        end
        ...
        def deserialize(params)
          ...
          unless params['Config'].nil?
            @Config = CameraControlConfig.new
      ...
      # 指定摄像机在不同方向上的运动或变化
      class CameraControlConfig < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Horizontal, :Vertical, :Pan, :Tilt, :Roll, :Zoom

        def initialize(horizontal=nil, vertical=nil, pan=nil, tilt=nil, roll=nil, zoom=nil)
      ...
      class DescribeImageToVideoJobResponse < TencentCloud::Common::AbstractModel
      ...
      class DescribeImageToVideoViduJobRequest < TencentCloud::Common::AbstractModel
        # @param JobId: <p>任务ID</p>
        # @type JobId: String
      ...
      class DescribeImageToVideoViduJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
        ...
        attr_accessor :Status, :ErrorCode, :ErrorMessage, :ResultVideoUrl, :Credits, :Payload, :RequestId

        def initialize(status=nil, errorcode=nil, errormessage=nil, resultvideourl=nil, credits=nil, payload=nil, requestid=nil)
          @Status = status
          @ErrorCode = errorcode
          @ErrorMessage = errormessage
          @ResultVideoUrl = resultvideourl
      ...
      class DescribeMotionControlKlingJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
        ...
        # @type Duration: String
        # @param FinalUnitDeduction: <p>消耗积分数。</p>
        # @type FinalUnitDeduction: String
        # @param VideoId: <p>视频id</p>
        # @type VideoId: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        ...
        attr_accessor :Status, :ErrorCode, :ErrorMessage, :ResultVideoUrl, :Duration, :FinalUnitDeduction, :VideoId, :RequestId

        def initialize(status=nil, errorcode=nil, errormessage=nil, resultvideourl=nil, duration=nil, finalunitdeduction=nil, videoid=nil, requestid=nil)
          @Status = status
          @ErrorCode = errorcode
          @ErrorMessage = errormessage
          @ResultVideoUrl = resultvideourl
      ...
      class DescribeReferenceToVideoViduJobRequest < TencentCloud::Common::AbstractModel
        # @param JobId: <p>任务ID</p>
        # @type JobId: String
      ...
      class DescribeReferenceToVideoViduJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
      ...
      class DescribeTextToVideoJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
      ...
      class DescribeTextToVideoViduJobRequest < TencentCloud::Common::AbstractModel
        # @param JobId: <p>任务ID</p>
        # @type JobId: String
      ...
      class DescribeTextToVideoViduJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
      ...
      class DescribeVideoEditKlingJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
      ...
      class DescribeVideoExtendKlingJobResponse < TencentCloud::Common::AbstractModel
        # @param Status: <p>任务状态。WAIT：等待中，RUN：执行中，FAIL：任务失败，DONE：任务成功</p>
        # @type Status: String
        # @param ErrorCode: <p>任务执行错误码。当任务状态不为 FAIL 时，该值为&quot;&quot;。</p>
        # @type ErrorCode: String
      ...
      # 动态笔刷
      class DynamicMask < TencentCloud::Common::AbstractModel
        ...
        # @type Trajectories: Array

        attr_accessor :Mask, :Trajectories

        def initialize(mask=nil, trajectories=nil)
          @Mask = mask
        ...
        def deserialize(params)
          @Mask = params['Mask']
          unless params['Trajectories'].nil?
            @Trajectories = []
            params['Trajectories'].each do |i|
              trajectory_tmp = Trajectory.new
              trajectory_tmp.deserialize(i)
              @Trajectories << trajectory_tmp
            end
          end
        end
      end
      ...
      class ImageInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ImageUrl, :Type

        def initialize(imageurl=nil, type=nil)
          @ImageUrl = imageurl
          @Type = type
        end
      ...
      class MultiPrompt < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Index, :Prompt, :Duration

        def initialize(index=nil, prompt=nil, duration=nil)
          @Index = index
          @Prompt = prompt
          @Duration = duration
        end
      ...
      # 参考视频信息
      class ReferVideoInfo < TencentCloud::Common::AbstractModel
        # @param VideoUrl: 视频地址
        ...
        def initialize(videourl=nil, refertype=nil, keeporiginalsound=nil)
          @VideoUrl = videourl
          @ReferType = refertype
        ...
        def deserialize(params)
          ...
          @ReferType = params['ReferType']
          @KeepOriginalSound = params['KeepOriginalSound']
        end
      end

      # 参考主体，主要用作参考图生视频。由主体id、主体图（三视图）以及声音组成。
      class ReferenceSubject < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Id, :Images, :Name, :Videos, :VoiceId

        def initialize(id=nil, images=nil, name=nil, videos=nil, voiceid=nil)
          @Id = id
          @Images = images
          @Name = name
          @Videos = videos
      ...
      class SubmitImageToVideoJobRequest < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          unless params['ImageTail'].nil?
            @ImageTail = Image.new
            @ImageTail.deserialize(params['ImageTail'])
          end
          @Prompt = params['Prompt']
          ...
          unless params['MultiPrompt'].nil?
            @MultiPrompt = []
            params['MultiPrompt'].each do |i|
              multiprompt_tmp = MultiPrompt.new
              multiprompt_tmp.deserialize(i)
              @MultiPrompt << multiprompt_tmp
            end
          end
          unless params['ElementList'].nil?
            @ElementList = []
            params['ElementList'].each do |i|
              element_tmp = Element.new
              element_tmp.deserialize(i)
              @ElementList << element_tmp
            end
          end
          @StaticMask = params['StaticMask']
          unless params['DynamicMasks'].nil?
            @DynamicMasks = []
            params['DynamicMasks'].each do |i|
              dynamicmask_tmp = DynamicMask.new
              dynamicmask_tmp.deserialize(i)
              @DynamicMasks << dynamicmask_tmp
            end
          end
          unless params['CameraControl'].nil?
            @CameraControl = CameraControl.new
            @CameraControl.deserialize(params['CameraControl'])
          end
          @CallbackUrl = params['CallbackUrl']
          unless params['VoiceList'].nil?
            @VoiceList = []
            params['VoiceList'].each do |i|
              voice_tmp = Voice.new
              voice_tmp.deserialize(i)
              @VoiceList << voice_tmp
            end
          end
          @ExternalTaskId = params['ExternalTaskId']
      ...
      class SubmitMotionControlKlingJobRequest < TencentCloud::Common::AbstractModel
      ...
      class SubmitReferenceToVideoViduJobRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Prompt, :Images, :Subjects, :Videos, :Model, :Audio, :AudioType, :Bgm, :Duration, :AspectRatio, :Resolution, :MovementAmplitude, :MetaData, :CallbackUrl, :Payload, :OffPeak, :LogoAdd, :LogoParam

        def initialize(prompt=nil, images=nil, subjects=nil, videos=nil, model=nil, audio=nil, audiotype=nil, bgm=nil, duration=nil, aspectratio=nil, resolution=nil, movementamplitude=nil, metadata=nil, callbackurl=nil, payload=nil, offpeak=nil, logoadd=nil, logoparam=nil)
          @Prompt = prompt
          @Images = images
          @Subjects = subjects
          @Videos = videos
        ...
        def deserialize(params)
          ...
          unless params['Subjects'].nil?
            ...
            params['Subjects'].each do |i|
              referencesubject_tmp = ReferenceSubject.new
              referencesubject_tmp.deserialize(i)
              @Subjects << referencesubject_tmp
            end
          end
          @Videos = params['Videos']
          @Model = params['Model']
      ...
      class SubmitReferenceToVideoViduJobResponse < TencentCloud::Common::AbstractModel
        # @param JobId: <p>任务ID。</p>
        # @type JobId: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class SubmitTextToVideoViduJobRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Prompt, :Model, :Duration, :Bgm, :AspectRatio, :Resolution, :Style, :MovementAmplitude, :Audio, :MetaData, :CallbackUrl, :Payload, :OffPeak, :LogoAdd, :LogoParam

        def initialize(prompt=nil, model=nil, duration=nil, bgm=nil, aspectratio=nil, resolution=nil, style=nil, movementamplitude=nil, audio=nil, metadata=nil, callbackurl=nil, payload=nil, offpeak=nil, logoadd=nil, logoparam=nil)
          @Prompt = prompt
          @Model = model
          @Duration = duration
          @Bgm = bgm
      ...
      class SubmitTextToVideoViduJobResponse < TencentCloud::Common::AbstractModel
        # @param JobId: <p>任务ID。</p>
        # @type JobId: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class SubmitVideoEditKlingJobRequest < TencentCloud::Common::AbstractModel
        # @param Prompt: <p>文本提示词，可包含正向描述和负向描述</p><p>可将提示词模板化来满足不同的视频生成需求</p><p>不能超过2500个字</p>
        # @type Prompt: String
        ...
        def deserialize(params)
          ...
          unless params['VideoList'].nil?
            ...
            params['VideoList'].each do |i|
              refervideoinfo_tmp = ReferVideoInfo.new
              refervideoinfo_tmp.deserialize(i)
              @VideoList << refervideoinfo_tmp
            end
          end
          @MultiShot = params['MultiShot']
          @ShotType = params['ShotType']
      ...
      class SubmitVideoExtendKlingJobRequest < TencentCloud::Common::AbstractModel
      ...
      # 运动轨迹坐标序列
      class Trajectory < TencentCloud::Common::AbstractModel
