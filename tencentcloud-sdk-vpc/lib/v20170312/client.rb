  ...
  module Vpc
    module V20170312
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::vpc::V20170312::DescribeDesignatedZonesRequest`
        # @rtype: :class:`Tencentcloud::vpc::V20170312::DescribeDesignatedZonesResponse`
        def DescribeDesignatedZones(request)
          body = send_request('DescribeDesignatedZones', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeDesignatedZonesResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
