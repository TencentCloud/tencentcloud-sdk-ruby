  ...
  module Cynosdb
    module V20190107
      ...
      class AddInstancesRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :InstanceGrpId, :none, 2026, 9
        deprecate :InstanceGrpId=, :none, 2026, 9
      ...
      class AddInstancesResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ResourceIds, :none, 2026, 9
        deprecate :ResourceIds=, :none, 2026, 9
      ...
      class BizTaskInfo < TencentCloud::Common::AbstractModel
        ...
        deprecate :InstanceGrpId, :none, 2026, 9
        deprecate :InstanceGrpId=, :none, 2026, 9
        deprecate :ModifyParamsData, :none, 2026, 9
        deprecate :ModifyParamsData=, :none, 2026, 9
      ...
      class DescribeClusterInstanceGrpsResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :InstanceGrpInfoList, :none, 2026, 9
        deprecate :InstanceGrpInfoList=, :none, 2026, 9
      ...
      class DescribeInstanceSpecsByOperationTypeRequest < TencentCloud::Common::AbstractModel
        # @param ClusterId: 集群ID
        # @type ClusterId: String
        ...
        attr_accessor :ClusterId, :OperationType, :InstanceId, :DeviceType

        def initialize(clusterid=nil, operationtype=nil, instanceid=nil, devicetype=nil)
          @ClusterId = clusterid
      ...
      class DescribeInstanceSpecsByOperationTypeResponse < TencentCloud::Common::AbstractModel
        # @param InstanceSpecSet: 实例规格信息
      ...
      class DescribeSlaveZonesRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Zone, :OssClusterId, :StorageVersion

        def initialize(zone=nil, ossclusterid=nil, storageversion=nil)
          @Zone = zone
      ...
      class ModifyClusterLevelRequest < TencentCloud::Common::AbstractModel
        # @param ClusterId: <p>集群ID</p>
        # @type ClusterId: String
        # @param ClusterLevel: <p>集群级别</p>
        # @type ClusterLevel: String

        attr_accessor :ClusterId, :ClusterLevel

        def initialize(clusterid=nil, clusterlevel=nil)
          @ClusterId = clusterid
          @ClusterLevel = clusterlevel
        end
      ...
      class ModifyClusterLevelResponse < TencentCloud::Common::AbstractModel
        # @param TaskId: <p>任务ID</p>
        # @type TaskId: Integer
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class Package < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AppId, :PackageId, :PackageName, :PackageType, :PackageVersion, :PackageRegion, :Status, :PackageTotalSpec, :PackageUsedSpec, :HasQuota, :BindInstanceInfos, :StartTime, :ExpireTime, :HistoryBindResourceInfos

        def initialize(appid=nil, packageid=nil, packagename=nil, packagetype=nil, packageversion=nil, packageregion=nil, status=nil, packagetotalspec=nil, packageusedspec=nil, hasquota=nil, bindinstanceinfos=nil, starttime=nil, expiretime=nil, historybindresourceinfos=nil)
          @AppId = appid
          @PackageId = packageid
          @PackageName = packagename
          @PackageType = packagetype
      ...
      class ProxyConfig < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ProxyCount, :none, 2026, 9
        deprecate :ProxyCount=, :none, 2026, 9
      ...
      class ProxyGroup < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ProxyGroupId, :ProxyNodeCount, :Status, :Region, :Zone, :CurrentProxyVersion, :ClusterId, :AppId, :OpenRw, :CreateTime, :UpdateTime

        def initialize(proxygroupid=nil, proxynodecount=nil, status=nil, region=nil, zone=nil, currentproxyversion=nil, clusterid=nil, appid=nil, openrw=nil, createtime=nil, updatetime=nil)
          @ProxyGroupId = proxygroupid
      ...
      class ProxyNodeInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ProxyNodeId, :ProxyNodeConnections, :Cpu, :Mem, :Status, :ProxyGroupId, :ClusterId, :AppId, :Region, :Zone, :OssProxyNodeName, :CreateTime, :UpdateTime

        def initialize(proxynodeid=nil, proxynodeconnections=nil, cpu=nil, mem=nil, status=nil, proxygroupid=nil, clusterid=nil, appid=nil, region=nil, zone=nil, ossproxynodename=nil, createtime=nil, updatetime=nil)
      ...
      class QueryFilter < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :Operator, :none, 2026, 9
        deprecate :Operator=, :none, 2026, 9
