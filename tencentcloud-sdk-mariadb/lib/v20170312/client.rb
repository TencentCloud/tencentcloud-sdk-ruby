  ...
  module Mariadb
    module V20170312
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::mariadb::V20170312::DescribeBinlogTimeRequest`
        # @rtype: :class:`Tencentcloud::mariadb::V20170312::DescribeBinlogTimeResponse`
        def DescribeBinlogTime(request)
          body = send_request('DescribeBinlogTime', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeBinlogTimeResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::mariadb::V20170312::UpgradeDedicatedDBInstanceRequest`
        # @rtype: :class:`Tencentcloud::mariadb::V20170312::UpgradeDedicatedDBInstanceResponse`
        def UpgradeDedicatedDBInstance(request)
          body = send_request('UpgradeDedicatedDBInstance', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = UpgradeDedicatedDBInstanceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::mariadb::V20170312::UpgradeHourDBInstanceRequest`
        # @rtype: :class:`Tencentcloud::mariadb::V20170312::UpgradeHourDBInstanceResponse`
        def UpgradeHourDBInstance(request)
          body = send_request('UpgradeHourDBInstance', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = UpgradeHourDBInstanceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
