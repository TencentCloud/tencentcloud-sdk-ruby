  ...
  module Tsf
    module V20180326
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::tsf::V20180326::DescribeMicroservicesByGroupIdsRequest`
        # @rtype: :class:`Tencentcloud::tsf::V20180326::DescribeMicroservicesByGroupIdsResponse`
        def DescribeMicroservicesByGroupIds(request)
          body = send_request('DescribeMicroservicesByGroupIds', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeMicroservicesByGroupIdsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
