  ...
  module Mrs
    module V20200910
      ...
      class BiologicalProductInfoName < TencentCloud::Common::AbstractModel
        ...
        deprecate :BarndName, :none, 2026, 4
        deprecate :BarndName=, :none, 2026, 4
      ...
      class Block < TencentCloud::Common::AbstractModel
        ...
        # @type EndoscopyV2: Array

        attr_accessor :Check, :Pathology, :MedDoc, :DiagCert, :FirstPage, :Indicator, :MedicalRecordInfo, :Hospitalization, :Surgery, :Prescription, :VaccineCertificate, :Electrocardiogram, :PathologyV2, :Endoscopy, :C14, :Exame, :MedDocV2, :IndicatorV3, :Maternity, :Timeline, :Covid, :Eye, :BirthCert, :TextTypeListBlocks, :PhysicalExamination, :EndoscopyV2

        def initialize(check=nil, pathology=nil, meddoc=nil, diagcert=nil, firstpage=nil, indicator=nil, medicalrecordinfo=nil, hospitalization=nil, surgery=nil, prescription=nil, vaccinecertificate=nil, electrocardiogram=nil, pathologyv2=nil, endoscopy=nil, c14=nil, exame=nil, meddocv2=nil, indicatorv3=nil, maternity=nil, timeline=nil, covid=nil, eye=nil, birthcert=nil, texttypelistblocks=nil, physicalexamination=nil, endoscopyv2=nil)
          @Check = check
          @Pathology = pathology
          @MedDoc = meddoc
          @DiagCert = diagcert
        ...
        def deserialize(params)
          ...
          unless params['EndoscopyV2'].nil?
            @EndoscopyV2 = []
            params['EndoscopyV2'].each do |i|
              check_tmp = Check.new
              check_tmp.deserialize(i)
              @EndoscopyV2 << check_tmp
            end
          end
        end
      end
      ...
      class Hospitalization < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :AdmissionDignosis, :none, 2026, 4
        deprecate :AdmissionDignosis=, :none, 2026, 4
      ...
      class IndicatorItem < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Code, :Scode, :Name, :Sname, :Result, :Unit, :Range, :Arrow, :Normal, :ItemString, :Id, :Coords, :InferNormal, :Sample, :Method, :ItemCoords
        extend Gem::Deprecate
        deprecate :Coords, :none, 2026, 4
        deprecate :Coords=, :none, 2026, 4

        def initialize(code=nil, scode=nil, name=nil, sname=nil, result=nil, unit=nil, range=nil, arrow=nil, normal=nil, itemstring=nil, id=nil, coords=nil, infernormal=nil, sample=nil, method=nil, itemcoords=nil)
          @Code = code
          @Scode = scode
          @Name = name
          @Sname = sname
        ...
        def deserialize(params)
          ...
          unless params['ItemCoords'].nil?
            @ItemCoords = ItemCoordinate.new
            @ItemCoords.deserialize(params['ItemCoords'])
          end
        end
      end
      ...
      class IndicatorV3 < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :TableIndictors, :none, 2026, 4
        deprecate :TableIndictors=, :none, 2026, 4
      ...
      # 检验指标内容坐标
      class ItemCoordinate < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Name, :Result, :Range

        def initialize(name=nil, result=nil, range=nil)
          @Name = name
          @Result = result
          @Range = range
        end
        ...
        def deserialize(params)
          ...
          unless params['Result'].nil?
            @Result = Coordinate.new
            @Result.deserialize(params['Result'])
          end
          unless params['Range'].nil?
            @Range = Coordinate.new
            @Range.deserialize(params['Range'])
          end
        end
      end
      ...
      class NormPart < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          unless params['PartDetailList'].nil?
            @PartDetailList = []
            params['PartDetailList'].each do |i|
              partdesc_tmp = PartDesc.new
              partdesc_tmp.deserialize(i)
              @PartDetailList << partdesc_tmp
            end
          end
        end
      end
      ...
      class Organ < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :IsthmusThicknese, :none, 2026, 4
        deprecate :IsthmusThicknese=, :none, 2026, 4
      ...
      class ParagraphBlock < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :MenstruallHistoryText, :none, 2026, 4
        deprecate :MenstruallHistoryText=, :none, 2026, 4
      ...
      class Template < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          unless params['EndoscopyV2'].nil?
            @EndoscopyV2 = Check.new
            @EndoscopyV2.deserialize(params['EndoscopyV2'])
          end
        end
      end
      ...
      class TreatmentRecord < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :DmissionCondition, :none, 2026, 4
        deprecate :DmissionCondition=, :none, 2026, 4
        deprecate :DiseasePresent, :none, 2026, 4
        deprecate :DiseasePresent=, :none, 2026, 4
