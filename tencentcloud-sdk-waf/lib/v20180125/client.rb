  ...
  module Waf
    module V20180125
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::waf::V20180125::CreateAndUpdateBatchCCRuleRequest`
        # @rtype: :class:`Tencentcloud::waf::V20180125::CreateAndUpdateBatchCCRuleResponse`
        def CreateAndUpdateBatchCCRule(request)
          body = send_request('CreateAndUpdateBatchCCRule', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateAndUpdateBatchCCRuleResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
