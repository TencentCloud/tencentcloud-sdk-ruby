  ...
  module Emr
    module V20190103
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::emr::V20190103::DescribeEMREventListRequest`
        # @rtype: :class:`Tencentcloud::emr::V20190103::DescribeEMREventListResponse`
        def DescribeEMREventList(request)
          body = send_request('DescribeEMREventList', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeEMREventListResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::emr::V20190103::DescribeMetaDBInfoRequest`
        # @rtype: :class:`Tencentcloud::emr::V20190103::DescribeMetaDBInfoResponse`
        def DescribeMetaDBInfo(request)
          body = send_request('DescribeMetaDBInfo', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeMetaDBInfoResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
