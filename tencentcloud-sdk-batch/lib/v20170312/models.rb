  ...
  module Batch
    module V20170312
      ...
      class DescribeJobMonitorDataRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :JobId, :TaskName, :TaskInstanceIndex, :MetricName, :StartTime, :EndTime, :Dimensions
      ...
      class DescribeJobMonitorDataResponse < TencentCloud::Common::AbstractModel
        # @param Period: <p>监控数据粒度，单位:秒；时间粒度随着查询的时间范围变化，查询时间范围越小，时间粒度越小。</p>
        # @type Period: Integer
        # @param DataPoints: <p>监控采集的数据。时间戳和对应的值一一对应；如果查询的任务重试，采集时间段涉及多个实例的话，某些时间段内的值为null, 表示对应时间点没有实例存在，也不存在对应的监控数据；相邻监控时间段之间的空值数量最多为10。</p>
      ...
      class EnvData < TencentCloud::Common::AbstractModel
        ...
        # @param InstanceChargeType: CVM实例计费类型<br><li>POSTPAID_BY_HOUR：按小时后付费</li><li>SPOTPAID：竞价付费</li><br>默认值：POSTPAID_BY_HOUR。
