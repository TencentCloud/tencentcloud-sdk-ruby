  ...
  module Teo
    module V20220901
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::teo::V20220901::DescribeAvailableOriginACLFamilyRequest`
        # @rtype: :class:`Tencentcloud::teo::V20220901::DescribeAvailableOriginACLFamilyResponse`
        def DescribeAvailableOriginACLFamily(request)
          body = send_request('DescribeAvailableOriginACLFamily', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeAvailableOriginACLFamilyResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @param request: Request instance for DummyParseZoneFullConfig.
        # @type request: :class:`Tencentcloud::teo::V20220901::DummyParseZoneFullConfigRequest`
        # @rtype: :class:`Tencentcloud::teo::V20220901::DummyParseZoneFullConfigResponse`
        def DummyParseZoneFullConfig(request)
          body = send_request('DummyParseZoneFullConfig', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DummyParseZoneFullConfigResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::teo::V20220901::ModifyZoneWorkModeRequest`
        # @rtype: :class:`Tencentcloud::teo::V20220901::ModifyZoneWorkModeResponse`
        def ModifyZoneWorkMode(request)
          body = send_request('ModifyZoneWorkMode', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
