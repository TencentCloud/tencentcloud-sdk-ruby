...
module TencentCloud
  module Teo
    module V20220901
      ...
      # 高级回源优化配置参数。
      class AdvancedOriginRoutingParameters < TencentCloud::Common::AbstractModel
      ...
      class CreateAccelerationDomainRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ZoneId, :DomainName, :OriginInfo, :OriginProtocol, :HttpOriginPort, :HttpsOriginPort, :IPv6Status, :SharedCNAME

        def initialize(zoneid=nil, domainname=nil, origininfo=nil, originprotocol=nil, httporiginport=nil, httpsoriginport=nil, ipv6status=nil, sharedcname=nil)
          @ZoneId = zoneid
          @DomainName = domainname
      ...
      class EdgeKVDeleteRequest < TencentCloud::Common::AbstractModel
        ...
        # @type Namespace: String
        # @param Keys: 键名列表。数组长度上限为 20。每个键名不能为空，长度为 1-512 个字符，支持合法 UTF-8 字符。删除单个键时传入包含一个元素的数组。
        # @type Keys: Array
      ...
      class EdgeKVGetRequest < TencentCloud::Common::AbstractModel
        ...
        # @type Namespace: String
        # @param Keys: 键名列表。数组长度上限为 20。每个键名不能为空，长度为 1-512 个字符，支持合法 UTF-8 字符。查询单个键时传入包含一个元素的数组。
        # @type Keys: Array
      ...
      class RateLimitingRule < TencentCloud::Common::AbstractModel
        ...
        # @type Name: String
        # @param Condition: 精准速率限制的具体内容，需符合表达式语法，详细规范参见[产品文档](https://cloud.tencent.com/document/product/1552/125343)。
        # @type Condition: String
        # @param Mode: 限速方式。在统计时间窗口 CountingPeriod 内，对满足特征 CountBy 的请求，支持配置以下限速方式：<li>Block: 阻断访问源。当统计次数超过阈值 MaxRequestThreshold 时，在 ActionDuration 时长内，对满足特征的所有后续请求执行 Action 处置；</li><li>Throttle: 仅处置超额请求。当统计次数超过阈值 MaxRequestThreshold 时，仅对超过阈值的请求执行 Action 处置，窗口结束后停止处置。此时，ActionDuration 参数将被忽略。</li><br />默认值为 Block。
        # @type Mode: String
        ...
        # @type CountingPeriod: String
        # @param ActionDuration: Action 动作的持续时长，单位仅支持：<li>s：秒，取值 1 ~ 120；</li><li>m：分钟，取值 1 ~ 120；</li><li>h：小时，取值 1 ~ 48；</li><li>d：天，取值 1 ~ 30。</li><br />当 Mode 为 Throttle 时，此参数将被忽略，不会生效。
        # @type ActionDuration: String
        ...
        attr_accessor :Id, :Name, :Condition, :Mode, :CountBy, :MaxRequestThreshold, :CountingPeriod, :ActionDuration, :Action, :Priority, :Enabled

        def initialize(id=nil, name=nil, condition=nil, mode=nil, countby=nil, maxrequestthreshold=nil, countingperiod=nil, actionduration=nil, action=nil, priority=nil, enabled=nil)
          @Id = id
          @Name = name
          @Condition = condition
          @Mode = mode
      ...
      class RuleEngineAction < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          unless params['AdvancedOriginRoutingParameters'].nil?
            @AdvancedOriginRoutingParameters = AdvancedOriginRoutingParameters.new
            @AdvancedOriginRoutingParameters.deserialize(params['AdvancedOriginRoutingParameters'])
          end
