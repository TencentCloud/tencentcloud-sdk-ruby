  ...
  module Ocr
    module V20181119
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::CropEnhanceImageOCRRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::CropEnhanceImageOCRResponse`
        def CropEnhanceImageOCR(request)
          body = send_request('CropEnhanceImageOCR', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CropEnhanceImageOCRResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::DescribeMarkEssayAgentJobRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::DescribeMarkEssayAgentJobResponse`
        def DescribeMarkEssayAgentJob(request)
          body = send_request('DescribeMarkEssayAgentJob', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeMarkEssayAgentJobResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::DescribeQuestionSplitJobRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::DescribeQuestionSplitJobResponse`
        def DescribeQuestionSplitJob(request)
          body = send_request('DescribeQuestionSplitJob', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeQuestionSplitJobResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::EraseHandwrittenImageOCRRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::EraseHandwrittenImageOCRResponse`
        def EraseHandwrittenImageOCR(request)
          body = send_request('EraseHandwrittenImageOCR', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = EraseHandwrittenImageOCRResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::RecognizeAgentRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::RecognizeAgentResponse`
        def RecognizeAgent(request)
          body = send_request('RecognizeAgent', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = RecognizeAgentResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::SubmitMarkEssayAgentJobRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::SubmitMarkEssayAgentJobResponse`
        def SubmitMarkEssayAgentJob(request)
          body = send_request('SubmitMarkEssayAgentJob', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = SubmitMarkEssayAgentJobResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::SubmitQuestionSplitJobRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::SubmitQuestionSplitJobResponse`
        def SubmitQuestionSplitJob(request)
          body = send_request('SubmitQuestionSplitJob', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = SubmitQuestionSplitJobResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @param request: Request instance for VerifyGeneralCardWarn.
        # @type request: :class:`Tencentcloud::ocr::V20181119::VerifyGeneralCardWarnRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::VerifyGeneralCardWarnResponse`
        def VerifyGeneralCardWarn(request)
          body = send_request('VerifyGeneralCardWarn', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = VerifyGeneralCardWarnResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::ocr::V20181119::VerifyScenePhotoRequest`
        # @rtype: :class:`Tencentcloud::ocr::V20181119::VerifyScenePhotoResponse`
        def VerifyScenePhoto(request)
          body = send_request('VerifyScenePhoto', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = VerifyScenePhotoResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
