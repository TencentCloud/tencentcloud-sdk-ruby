  ...
  module Ocr
    module V20181119
      ...
      class VehicleRegCertInfo < TencentCloud::Common::AbstractModel
        # @param Name: <p>识别出的字段名称(关键字)，支持以下字段： 【注册登记信息栏/摘要信息栏、转移登记摘要信息栏】 车辆型号、车辆识别代号/车架号、发动机号、制造厂名称、轴距、轮胎数、总质量、外廓尺寸、轴数、车辆出厂日期、发证日期、使用性质、车辆获得方式、车辆类型、国产/进口、燃料种类、车身颜色、发动机型号、车辆品牌、编号、转向形式、 机动车所有人1、身份证明名称1、号码1、登记机关1、登记日期1 机动车所有人2、身份证明名称2、号码2、登记机关2、登记日期2 机动车所有人3、身份证明名称3、号码3、登记机关3、登记日期3 机动车所有人4、身份证明名称4、号码4、登记机关4、登记日期4 机动车所有人5、身份证明名称5、号码5、登记机关5、登记日期5 机动车所有人6、身份证明名称6、号码6、登记机关6、登记日期6 机动车所有人7、身份证明名称7、号码7、登记机关7、登记日期7 【登记栏】 机动车登记证书编号、标题（目前支持转让登记、抵押登记、解除抵押）  [标题：转让登记]  姓名/名称、身份证明名称/号码、获得方式、机动车登记编号、转让登记日期  [标题：抵押登记]  抵押权人姓名/名称、身份证明名称/号码、抵押登记日期  [标题：解除抵押]  解除抵押日期    示例值：标题</p>
        # @type Name: String
        # @param Value: <p>识别出的字段名称对应的值，也就是字段name对应的字符串结果。 示例值：解除抵押</p>
        # @type Value: String
