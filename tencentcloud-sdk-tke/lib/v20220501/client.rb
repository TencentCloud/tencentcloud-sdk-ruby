  ...
  module Tke
    module V20220501
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::tke::V20220501::ModifyClusterMachineRequest`
        # @rtype: :class:`Tencentcloud::tke::V20220501::ModifyClusterMachineResponse`
        ...
        # @type request: :class:`Tencentcloud::tke::V20220501::ScaleNodePoolRequest`
        # @rtype: :class:`Tencentcloud::tke::V20220501::ScaleNodePoolResponse`
        def ScaleNodePool(request)
          body = send_request('ScaleNodePool', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ScaleNodePoolResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::tke::V20220501::SetMachineLoginRequest`
        # @rtype: :class:`Tencentcloud::tke::V20220501::SetMachineLoginResponse`
        def SetMachineLogin(request)
          body = send_request('SetMachineLogin', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = SetMachineLoginResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
