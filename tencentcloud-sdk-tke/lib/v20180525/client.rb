  ...
  module Tke
    module V20180525
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::tke::V20180525::EnableEksEventPersistenceRequest`
        # @rtype: :class:`Tencentcloud::tke::V20180525::EnableEksEventPersistenceResponse`
        def EnableEksEventPersistence(request)
          body = send_request('EnableEksEventPersistence', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = EnableEksEventPersistenceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::tke::V20180525::RotateClusterTokenRequest`
        # @rtype: :class:`Tencentcloud::tke::V20180525::RotateClusterTokenResponse`
        def RotateClusterToken(request)
          body = send_request('RotateClusterToken', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = RotateClusterTokenResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
