  ...
  module Cbs
    module V20170312
      ...
      class RemoteDiskDetail < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CreateTime, :DeadlineTime, :DiskChargeType, :DiskSize, :InstanceId, :Placement, :RemoteDiskId, :RemoteDiskName, :RemoteDiskState, :RemoteDiskType, :RenewFlag

        def initialize(createtime=nil, deadlinetime=nil, diskchargetype=nil, disksize=nil, instanceid=nil, placement=nil, remotediskid=nil, remotediskname=nil, remotediskstate=nil, remotedisktype=nil, renewflag=nil)
          @CreateTime = createtime
          @DeadlineTime = deadlinetime
          @DiskChargeType = diskchargetype
          @DiskSize = disksize
          ...
          @RemoteDiskState = remotediskstate
          @RemoteDiskType = remotedisktype
          @RenewFlag = renewflag
        end
        ...
        def deserialize(params)
          ...
          @RemoteDiskName = params['RemoteDiskName']
          @RemoteDiskState = params['RemoteDiskState']
          @RemoteDiskType = params['RemoteDiskType']
          @RenewFlag = params['RenewFlag']
        end
      end
      ...
      class RenewDiskRequest < TencentCloud::Common::AbstractModel
        ...
        # @type DiskChargePrepaid: :class:`Tencentcloud::Cbs.v20170312.models.DiskChargePrepaid`
        # @param DiskId: <p>云硬盘ID， 通过<a href="/document/product/362/16315">DescribeDisks</a>接口查询。</p>
        # @type DiskId: String
