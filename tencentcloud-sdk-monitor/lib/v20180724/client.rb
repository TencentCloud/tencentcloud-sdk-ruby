  ...
  module Monitor
    module V20180724
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::CheckAddressByPrometheusRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::CheckAddressByPrometheusResponse`
        def CheckAddressByPrometheus(request)
          body = send_request('CheckAddressByPrometheus', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CheckAddressByPrometheusResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::DescribeGrafanaVersionsRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::DescribeGrafanaVersionsResponse`
        def DescribeGrafanaVersions(request)
          body = send_request('DescribeGrafanaVersions', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeGrafanaVersionsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::DescribePrometheusAlertmanagerConfigRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::DescribePrometheusAlertmanagerConfigResponse`
        def DescribePrometheusAlertmanagerConfig(request)
          body = send_request('DescribePrometheusAlertmanagerConfig', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribePrometheusAlertmanagerConfigResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::DescribePrometheusCreateInstanceQuotaRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::DescribePrometheusCreateInstanceQuotaResponse`
        def DescribePrometheusCreateInstanceQuota(request)
          body = send_request('DescribePrometheusCreateInstanceQuota', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribePrometheusCreateInstanceQuotaResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::ReplacePrometheusAlertmanagerConfigRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::ReplacePrometheusAlertmanagerConfigResponse`
        def ReplacePrometheusAlertmanagerConfig(request)
          body = send_request('ReplacePrometheusAlertmanagerConfig', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ReplacePrometheusAlertmanagerConfigResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::monitor::V20180724::RoutePrometheusDynamicAPIRequest`
        # @rtype: :class:`Tencentcloud::monitor::V20180724::RoutePrometheusDynamicAPIResponse`
        def RoutePrometheusDynamicAPI(request)
          body = send_request('RoutePrometheusDynamicAPI', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = RoutePrometheusDynamicAPIResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
