  ...
  module Dataagent
    module V20250513
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::dataagent::V20250513::GetUserInstanceListRequest`
        # @rtype: :class:`Tencentcloud::dataagent::V20250513::GetUserInstanceListResponse`
        def GetUserInstanceList(request)
          body = send_request('GetUserInstanceList', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = GetUserInstanceListResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
