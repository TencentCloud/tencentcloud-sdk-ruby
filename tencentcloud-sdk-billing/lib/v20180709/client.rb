  ...
  module Billing
    module V20180709
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::billing::V20180709::DescribeOrgMemberAccountBalanceRequest`
        # @rtype: :class:`Tencentcloud::billing::V20180709::DescribeOrgMemberAccountBalanceResponse`
        def DescribeOrgMemberAccountBalance(request)
          body = send_request('DescribeOrgMemberAccountBalance', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeOrgMemberAccountBalanceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
