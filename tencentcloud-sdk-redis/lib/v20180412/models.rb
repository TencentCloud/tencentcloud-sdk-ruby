  ...
  module Redis
    module V20180412
      ...
      class ChangeReplicaToMasterRequest < TencentCloud::Common::AbstractModel
        ...
        # @type Emergency: Boolean

        attr_accessor :InstanceId, :GroupId, :Emergency

        def initialize(instanceid=nil, groupid=nil, emergency=nil)
          @InstanceId = instanceid
          @GroupId = groupid
          @Emergency = emergency
        end
      ...
      class CloneInstancesRequest < TencentCloud::Common::AbstractModel
        ...
        def initialize(instanceid=nil, goodsnum=nil, zoneid=nil, billingmode=nil, period=nil, securitygroupidlist=nil, backupid=nil, noauth=nil, vpcid=nil, subnetid=nil, instancename=nil, password=nil, autorenew=nil, vport=nil, nodeset=nil, projectid=nil, resourcetags=nil, templateid=nil, alarmpolicylist=nil, clonetime=nil, encryptpassword=nil, passwordpolicy=nil, enablessl=nil, sslbindprivateipv4=nil, productversion=nil)
          ...
          @EnableSSL = enablessl
          @SSLBindPrivateIPv4 = sslbindprivateipv4
        ...
        def deserialize(params)
          ...
          @SSLBindPrivateIPv4 = params['SSLBindPrivateIPv4']
      ...
      class DescribeBackupUrlResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :DownloadUrl, :none, 2026, 8
        deprecate :DownloadUrl=, :none, 2026, 8
        deprecate :InnerDownloadUrl, :none, 2026, 8
        deprecate :InnerDownloadUrl=, :none, 2026, 8
        deprecate :Filenames, :none, 2026, 8
        deprecate :Filenames=, :none, 2026, 8
      ...
      class DescribeSSLStatusRequest < TencentCloud::Common::AbstractModel
        # @param InstanceId: <p>实例 ID。请登录 <a href="https://console.cloud.tencent.com/redis/instance/list">Redis 控制台</a>在实例列表复制实例 ID。</p>
        # @type InstanceId: String
      ...
      class DescribeSSLStatusResponse < TencentCloud::Common::AbstractModel
        ...
        # @type EncryptAddress: String
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :CertDownloadUrl, :UrlExpiredTime, :SSLConfig, :FeatureSupport, :Status, :AddressType, :EncryptAddress, :RequestId

        def initialize(certdownloadurl=nil, urlexpiredtime=nil, sslconfig=nil, featuresupport=nil, status=nil, addresstype=nil, encryptaddress=nil, requestid=nil)
        ...
        def deserialize(params)
          ...
          @Status = params['Status']
          @AddressType = params['AddressType']
          @EncryptAddress = params['EncryptAddress']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeSlowLogResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :InstanceSlowlogDetail, :none, 2026, 8
        deprecate :InstanceSlowlogDetail=, :none, 2026, 8
      ...
      class DescribeTaskListRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ProjectIds, :none, 2026, 8
        deprecate :ProjectIds=, :none, 2026, 8
        deprecate :OperatorUin, :none, 2026, 8
        deprecate :OperatorUin=, :none, 2026, 8
      ...
      class FailedInstance < TencentCloud::Common::AbstractModel
        # @param InstanceId: <p>失败实例ID</p>
        # @type InstanceId: String
        # @param Message: <p>失败信息</p>
        # @type Message: String

        attr_accessor :InstanceId, :Message

        def initialize(instanceid=nil, message=nil)
          @InstanceId = instanceid
          @Message = message
        end
      ...
      class InstanceSet < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :SizeUsed, :none, 2026, 8
        deprecate :SizeUsed=, :none, 2026, 8
      ...
      class ModifyInstanceChargeTypeRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceIds, :InstanceChargeType, :Period

        def initialize(instanceids=nil, instancechargetype=nil, period=nil)
          @InstanceIds = instanceids
      ...
      class ModifyInstanceChargeTypeResponse < TencentCloud::Common::AbstractModel
        # @param FailedInstanceIds: <p>修改失败的实例信息汇总</p>
        # @type FailedInstanceIds: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :FailedInstanceIds, :RequestId

        def initialize(failedinstanceids=nil, requestid=nil)
          @FailedInstanceIds = failedinstanceids
          @RequestId = requestid
        end

        def deserialize(params)
          unless params['FailedInstanceIds'].nil?
            @FailedInstanceIds = []
            params['FailedInstanceIds'].each do |i|
              failedinstance_tmp = FailedInstance.new
              failedinstance_tmp.deserialize(i)
              @FailedInstanceIds << failedinstance_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class ModifyInstanceRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :InstanceId=, :none, 2026, 8
        deprecate :InstanceName, :none, 2026, 8
        deprecate :InstanceName=, :none, 2026, 8
        deprecate :AutoRenew, :none, 2026, 8
        deprecate :AutoRenew=, :none, 2026, 8
      ...
      # Redis实例级密码复杂度
      class PasswordPolicy < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Enabled, :MinLetterCount, :MinDigitCount, :MinSpecialCount, :MinLength

        def initialize(enabled=nil, minlettercount=nil, mindigitcount=nil, minspecialcount=nil, minlength=nil)
          @Enabled = enabled
          @MinLetterCount = minlettercount
          @MinDigitCount = mindigitcount
          @MinSpecialCount = minspecialcount
          @MinLength = minlength
        end

        def deserialize(params)
          @Enabled = params['Enabled']
          @MinLetterCount = params['MinLetterCount']
          @MinDigitCount = params['MinDigitCount']
          @MinSpecialCount = params['MinSpecialCount']
      ...
      class ProductConf < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :EnableRepicaReadOnly, :none, 2026, 8
        deprecate :EnableRepicaReadOnly=, :none, 2026, 8
      ...
      class SwitchProxyRequest < TencentCloud::Common::AbstractModel
        ...
        # @type ProxyID: String
        # @param ProxyIDList: 实例 ProxyID列表，请通过接口[DescribeInstanceNodeInfo](https://cloud.tencent.com/document/product/239/48603)的返回参数**Proxy**中的**NodeId**获取。
        # @type ProxyIDList: Array

        attr_accessor :InstanceId, :ProxyID, :ProxyIDList

        def initialize(instanceid=nil, proxyid=nil, proxyidlist=nil)
          @InstanceId = instanceid
          @ProxyID = proxyid
