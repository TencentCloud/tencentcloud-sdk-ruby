  ...
  module Asr
    module V20190614
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::asr::V20190614::VoicePrintGroupListRequest`
        # @rtype: :class:`Tencentcloud::asr::V20190614::VoicePrintGroupListResponse`
        def VoicePrintGroupList(request)
          body = send_request('VoicePrintGroupList', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = VoicePrintGroupListResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
