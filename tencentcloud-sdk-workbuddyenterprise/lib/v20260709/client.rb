  ...
  module Workbuddyenterprise
    module V20260709
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @param request: Request instance for DescribeUserAccessToken.
        # @type request: :class:`Tencentcloud::workbuddyenterprise::V20260709::DescribeUserAccessTokenRequest`
        # @rtype: :class:`Tencentcloud::workbuddyenterprise::V20260709::DescribeUserAccessTokenResponse`
        def DescribeUserAccessToken(request)
          body = send_request('DescribeUserAccessToken', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeUserAccessTokenResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
