  ...
  module Cfs
    module V20190719
      ...
      class DescribeAvailableZoneInfoResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @RegionZones = params['RegionZones']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeMountTargetsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @MountTargets = params['MountTargets']
      ...
      class MountInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :FileSystemId, :MountTargetId, :IpAddress, :FSID, :LifeCycleState, :NetworkInterface, :VpcId, :VpcName, :SubnetId, :SubnetName
        
        def initialize(filesystemid=nil, mounttargetid=nil, ipaddress=nil, fsid=nil, lifecyclestate=nil, networkinterface=nil, vpcid=nil, vpcname=nil, subnetid=nil, subnetname=nil)
          @FileSystemId = filesystemid
          @MountTargetId = mounttargetid
          @IpAddress = ipaddress
          @FSID = fsid
