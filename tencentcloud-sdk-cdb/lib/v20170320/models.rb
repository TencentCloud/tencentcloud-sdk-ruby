  ...
  module Cdb
    module V20170320
      ...
      class AnalyzeAuditLogsRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :AuditLogFilter, :none, 2026, 7
        deprecate :AuditLogFilter=, :none, 2026, 7
      ...
      class AuditLog < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AffectRows, :ErrCode, :SqlType, :PolicyName, :DBName, :Sql, :Host, :User, :ExecTime, :Timestamp, :SentRows, :ThreadId, :CheckRows, :CpuTime, :IoWaitTime, :LockWaitTime, :NsTime, :TrxLivingTime, :TemplateInfo, :TrxId, :ClientPort

        def initialize(affectrows=nil, errcode=nil, sqltype=nil, policyname=nil, dbname=nil, sql=nil, host=nil, user=nil, exectime=nil, timestamp=nil, sentrows=nil, threadid=nil, checkrows=nil, cputime=nil, iowaittime=nil, lockwaittime=nil, nstime=nil, trxlivingtime=nil, templateinfo=nil, trxid=nil, clientport=nil)
      ...
      class AutoStrategy < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ExpandPeriod, :none, 2026, 7
        deprecate :ExpandPeriod=, :none, 2026, 7
        deprecate :ShrinkPeriod, :none, 2026, 7
        deprecate :ShrinkPeriod=, :none, 2026, 7
      ...
      class CreateCloneInstanceRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :MasterZone, :none, 2026, 7
        deprecate :MasterZone=, :none, 2026, 7
      ...
      class DescribeBackupConfigResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :StartTimeMin, :none, 2026, 7
        deprecate :StartTimeMin=, :none, 2026, 7
        deprecate :StartTimeMax, :none, 2026, 7
        deprecate :StartTimeMax=, :none, 2026, 7
      ...
      class DescribeProxyCustomConfResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :CustomConf, :none, 2026, 7
        deprecate :CustomConf=, :none, 2026, 7
      ...
      class IsolateDBInstanceResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AsyncRequestId, :RequestId
        extend Gem::Deprecate
        deprecate :AsyncRequestId, :none, 2026, 7
        deprecate :AsyncRequestId=, :none, 2026, 7
      ...
      class ModifyAccountPasswordRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :SkipValidatePassword, :none, 2026, 7
        deprecate :SkipValidatePassword=, :none, 2026, 7
      ...
      class ModifyDBInstanceLogToCLSRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceId, :LogType, :Status, :CreateLogset, :Logset, :CreateLogTopic, :LogTopic, :Period, :CreateIndex, :ClsRegion, :ResourceTags

        def initialize(instanceid=nil, logtype=nil, status=nil, createlogset=nil, logset=nil, createlogtopic=nil, logtopic=nil, period=nil, createindex=nil, clsregion=nil, resourcetags=nil)
          @InstanceId = instanceid
          @LogType = logtype
          @Status = status
      ...
      class ModifyRoGroupInfoRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :ReplicationDelayTime, :none, 2026, 7
        deprecate :ReplicationDelayTime=, :none, 2026, 7
      ...
      class ParamRecord < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :IsSucess, :none, 2026, 7
        deprecate :IsSucess=, :none, 2026, 7
