  ...
  module Cdb
    module V20170320
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::cdb::V20170320::ModifyRoGroupVipVportRequest`
        # @rtype: :class:`Tencentcloud::cdb::V20170320::ModifyRoGroupVipVportResponse`
        def ModifyRoGroupVipVport(request)
          body = send_request('ModifyRoGroupVipVport', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ModifyRoGroupVipVportResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
