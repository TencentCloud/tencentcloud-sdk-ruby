  ...
  module Cfw
    module V20190904
      ...
      class AddEnterpriseSecurityGroupRulesRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Data, :CfwAiAgentOperationSource, :ClientToken, :From, :IsDelay, :IsUseId, :Type

        def initialize(data=nil, cfwaiagentoperationsource=nil, clienttoken=nil, from=nil, isdelay=nil, isuseid=nil, type=nil)
          @Data = data
          @CfwAiAgentOperationSource = cfwaiagentoperationsource
      ...
      class AddEnterpriseSecurityGroupRulesResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Rules, :Status, :RequestId

        def initialize(rules=nil, status=nil, requestid=nil)
          @Rules = rules
          @Status = status
          @RequestId = requestid
        end
      ...
      class AddVpcAcRuleResponse < TencentCloud::Common::AbstractModel
        # @param RuleUuids: 新增规则的 ID 列表，顺序与 Rules 一致。
      ...
      class BanAndAllowRuleDel < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :DirectionList, :Ioc, :RuleType

        def initialize(directionlist=nil, ioc=nil, ruletype=nil)
          @DirectionList = directionlist
          @Ioc = ioc
          @RuleType = ruletype
        end
      ...
      class BetaInfoByACL < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :LastTime, :TaskId, :TaskName

        def initialize(lasttime=nil, taskid=nil, taskname=nil)
          @LastTime = lasttime
          @TaskId = taskid
          @TaskName = taskname
        end
      ...
      class BlockInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SrcIP, :DstIP, :DstPort, :AppID, :AssetId, :AssetName, :Zone, :MaxDate, :MinDate, :Direction, :BlockSource, :Country, :Count, :AvgCount, :IsTop, :UniqueId, :ByPass, :Block, :Ignore, :WhiteTag, :DstAssetId, :DstAssetName, :SrcVpc, :SrcVpcName, :DstVpc, :DstVpcName, :EdgeId, :EdgeName, :LogSource, :Isolate, :Hide, :Domain

        def initialize(srcip=nil, dstip=nil, dstport=nil, appid=nil, assetid=nil, assetname=nil, zone=nil, maxdate=nil, mindate=nil, direction=nil, blocksource=nil, country=nil, count=nil, avgcount=nil, istop=nil, uniqueid=nil, bypass=nil, block=nil, ignore=nil, whitetag=nil, dstassetid=nil, dstassetname=nil, srcvpc=nil, srcvpcname=nil, dstvpc=nil, dstvpcname=nil, edgeid=nil, edgename=nil, logsource=nil, isolate=nil, hide=nil, domain=nil)
          @SrcIP = srcip
          @DstIP = dstip
          @DstPort = dstport
          @AppID = appid
        ...
        def deserialize(params)
          ...
          @WhiteTag = params['WhiteTag']
          @DstAssetId = params['DstAssetId']
          @DstAssetName = params['DstAssetName']
          @SrcVpc = params['SrcVpc']
          @SrcVpcName = params['SrcVpcName']
          @DstVpc = params['DstVpc']
          @DstVpcName = params['DstVpcName']
      ...
      class CheckClusterNatFwPreAccessRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :NatCcnSwitch, :CheckMode

        def initialize(natccnswitch=nil, checkmode=nil)
      ...
      class CheckClusterNatFwPreAccessResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CheckItems, :RequestId

        def initialize(checkitems=nil, requestid=nil)
        ...
        def deserialize(params)
          unless params['CheckItems'].nil?
            ...
            params['CheckItems'].each do |i|
              clusterfwpreaccesscheckitem_tmp = ClusterFwPreAccessCheckItem.new
              clusterfwpreaccesscheckitem_tmp.deserialize(i)
              @CheckItems << clusterfwpreaccesscheckitem_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class CheckClusterVpcFwPreAccessRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CcnSwitch, :CheckMode

        def initialize(ccnswitch=nil, checkmode=nil)
          @CcnSwitch = ccnswitch
          @CheckMode = checkmode
        end
      ...
      class CheckClusterVpcFwPreAccessResponse < TencentCloud::Common::AbstractModel
        # @param CheckItems: <p>检查项清单，按执行顺序返回。前端据此渲染检查项骨架，描述文案已按请求的 Language 返回对应语言（中文/英文）。检查通过轮询 DescribeClusterVpcFwSwitchs 接口读取 CheckResult 获取每个阶段的通过/失败状态。</p>
        # @type CheckItems: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      # 预接入检查项定义
      class ClusterFwPreAccessCheckItem < TencentCloud::Common::AbstractModel
        # @param Stage: 检查项 key，与查询接口 CheckResult.Stages[].Stage 一一对应
        # @type Stage: String
        # @param Description: 该检查项的展示文案，已按请求的 Language 返回中文或英文
        # @type Description: String

        attr_accessor :Stage, :Description

        def initialize(stage=nil, description=nil)
          @Stage = stage
          @Description = description
        end
      ...
      class CreateAlertCenterRuleAsyncRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AlertDirection, :HandleDirection, :HandleTime, :HandleType, :AssetIdList, :BlockDomain, :CfwAiAgentOperationSource, :HandleComment, :HandleEventIdList, :HandleIdList, :HandleIpList, :IgnoreReason, :IsolateType, :TargetEventIdList, :WhiteIpList

        def initialize(alertdirection=nil, handledirection=nil, handletime=nil, handletype=nil, assetidlist=nil, blockdomain=nil, cfwaiagentoperationsource=nil, handlecomment=nil, handleeventidlist=nil, handleidlist=nil, handleiplist=nil, ignorereason=nil, isolatetype=nil, targeteventidlist=nil, whiteiplist=nil)
          @AlertDirection = alertdirection
      ...
      class CreateBlockIgnoreRuleNewRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :RuleType, :Rules, :CfwAiAgentOperationSource, :CoverDuplicate

        def initialize(ruletype=nil, rules=nil, cfwaiagentoperationsource=nil, coverduplicate=nil)
          @RuleType = ruletype
          @Rules = rules
          @CfwAiAgentOperationSource = cfwaiagentoperationsource
          @CoverDuplicate = coverduplicate
      ...
      class CreateNatRuleItem < TencentCloud::Common::AbstractModel
        ...
        # @type Direction: Integer
        # @param OrderIndex: <p>规则顺序。使用 -1 追加到当前方向末尾，使用正序号在对应位置插入并顺延后续规则；0 按 1 处理，其他负数及超范围值不应使用。批量新增时按 Rules 顺序依次处理。</p>
        # @type OrderIndex: Integer
        ...
        # @type Port: String
        # @param Protocol: <p>协议，大小写不敏感并归一化为大写。四层值为 TCP、UDP、ICMP、ICMPV6、ANY；应用层值为 HTTP、HTTPS、HTTP/HTTPS、TLS/SSL、SMTP、SMTPS、SMTP/SMTPS、FTP、DNS，其中 domain、tls、ssl 也归一化为 TLS/SSL；ANY 表示不限定协议，不表示省略 Protocol；它同时可按四层协议和应用协议解析。入站仅允许 ANY、TCP、UDP；domain 目的及解析为域名模板的 template 目的接受上述应用层协议及 ANY，但不接受 FTP；dnsparse 和 domainiptwoverify 目的仅允许 TCP 或 UDP；其他目的不接受 FTP 和 ANY 之外的应用层协议。Protocol=DNS 且目的不是域名模板或单独的 * 时，目的列表只能包含域名，不能包含 IP。</p>
        # @type Protocol: String
        # @param RuleAction: <p>流量处理方式，大小写不敏感：accept 表示放行，drop 表示拒绝，log 表示观察；isolateinaccept 表示放行访问隔离资产的白名单流量，isolateindrop 表示阻断访问隔离资产的其它流量，isolateoutaccept 表示放行隔离资产访问白名单目标，isolateoutdrop 表示阻断隔离资产访问其它目标。</p>
        # @type RuleAction: String
        # @param SourceContent: <p>访问源内容，格式由 SourceType 和 Direction 决定。net/ip 使用合法 IP 或 CIDR 的逗号列表，最多 10 项；location 使用地域 code，空字符串表示全部地域；vendor 使用 tencent、aliyun、aws、huawei、azure 或 all，可用逗号分隔；template 使用地址模板 ID；instance 使用资产实例 ID；group 使用资源组 ID；tag 使用 JSON 字符串 {"Key":"标签键","Value":"标签值"}，Key 和 Value 大小写固定。</p>
        # @type SourceContent: String
        # @param SourceType: <p>访问源类型，大小写不敏感。net、ip 均表示 IP/CIDR，template 表示地址模板，instance 表示资产实例，group 表示资产分组，tag 表示资源标签，location 表示地域，vendor 表示云厂商。入站支持 net、ip、template、location、vendor；出站支持 net、ip、template、instance、group、tag。</p>
        ...
        # @type Enable: String
        # @param InternalUuid: <p>覆盖导入规则标识。仅 From=batch_import_cover 接受正整数值；其它新增方式和修改请求忽略该字段。</p>
        # @type InternalUuid: Integer
        # @param ParamTemplateId: <p>端口协议模板 ID。省略或传空字符串时使用 Protocol 和 Port；非空时必须指向当前账号已有的模板，模板条目须满足协议与目的类型的联动限制。使用模板时，Protocol 仍须有效；Protocol 不是 ICMP 时，Port 也须有效，但二者不要求固定为 ANY 和 -1/-1。</p>
        ...
        # @type Scope: String
        # @param Uuid: <p>规则 ID。普通新增、insert_rule 和 batch_import 忽略该字段；batch_import_cover 可使用正整数 ID。修改时必须提供当前账号已有且可修改的正整数 ID，并以请求中的完整字段替换该规则，同时保留并返回同一 Uuid；省略、0 或负值无法定位修改目标。</p>
        # @type Uuid: Integer

        attr_accessor :Direction, :OrderIndex, :Port, :Protocol, :RuleAction, :SourceContent, :SourceType, :TargetContent, :TargetType, :Description, :Enable, :InternalUuid, :ParamTemplateId, :Scope, :Uuid

        def initialize(direction=nil, orderindex=nil, port=nil, protocol=nil, ruleaction=nil, sourcecontent=nil, sourcetype=nil, targetcontent=nil, targettype=nil, description=nil, enable=nil, internaluuid=nil, paramtemplateid=nil, scope=nil, uuid=nil)
          @Direction = direction
          @OrderIndex = orderindex
          @Port = port
          @Protocol = protocol
      ...
      class CreateRuleItem < TencentCloud::Common::AbstractModel
        ...
        def initialize(direction=nil, orderindex=nil, port=nil, protocol=nil, ruleaction=nil, sourcecontent=nil, sourcetype=nil, targetcontent=nil, targettype=nil, description=nil, enable=nil, logid=nil, paramtemplateid=nil, rulesource=nil, scope=nil, uuid=nil)
          @Direction = direction
          @OrderIndex = orderindex
          @Port = port
          @Protocol = protocol
      ...
      class CustomWhiteRule < TencentCloud::Common::AbstractModel
        ...
        # @type DstIP: String
        # @param IdsRuleId: 自定义规则关联的入侵防御规则 ID。调用 DescribeIpsRuleListNew，传目标规则的查询条件，仅使用 Data[].RuleID；该值必须可转换为整数且对应现有入侵防御规则。
      ...
      class DeleteBlockIgnoreRuleNewRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :DeleteAll, :CfwAiAgentOperationSource, :RuleType, :Rules, :ShowType

        def initialize(deleteall=nil, cfwaiagentoperationsource=nil, ruletype=nil, rules=nil, showtype=nil)
          @DeleteAll = deleteall
          @CfwAiAgentOperationSource = cfwaiagentoperationsource
          @RuleType = ruletype
          @Rules = rules
      ...
      class DescribeBlockListRequest < TencentCloud::Common::AbstractModel
        # @param Offset: 偏移量
        # @type Offset: Integer
        # @param Limit: 长度
        # @type Limit: Integer
        # @param StatTimeSpan: 频率类型
        # @type StatTimeSpan: Integer
        # @param StartTime: 开始时间
        # @type StartTime: String
        # @param EndTime: 结束时间
        # @type EndTime: String
        ...
        attr_accessor :Offset, :Limit, :StatTimeSpan, :StartTime, :EndTime, :SearchValue, :Order, :By, :Direction, :ByPass, :Source, :Country, :AssetId, :LogSource

        def initialize(offset=nil, limit=nil, stattimespan=nil, starttime=nil, endtime=nil, searchvalue=nil, order=nil, by=nil, direction=nil, bypass=nil, source=nil, country=nil, assetid=nil, logsource=nil)
          @Offset = offset
          @Limit = limit
        ...
        def deserialize(params)
          @Offset = params['Offset']
          @Limit = params['Limit']
          @StatTimeSpan = params['StatTimeSpan']
          @StartTime = params['StartTime']
          @EndTime = params['EndTime']
          @SearchValue = params['SearchValue']
          @Order = params['Order']
      ...
      class DescribeBlockListResponse < TencentCloud::Common::AbstractModel
        # @param Data: 阻断记录集合
        # @type Data: Array
        # @param TopData: 置顶阻断记录集合
        # @type TopData: Array
        # @param Total: 数量
        # @type Total: Integer
        # @param TopCount: 置顶数量
        ...
        attr_accessor :Data, :TopData, :Total, :TopCount, :RequestId

        def initialize(data=nil, topdata=nil, total=nil, topcount=nil, requestid=nil)
          @Data = data
          @TopData = topdata
          @Total = total
          @TopCount = topcount
        ...
        def deserialize(params)
          ...
          unless params['TopData'].nil?
            @TopData = []
            params['TopData'].each do |i|
              blockinfo_tmp = BlockInfo.new
              blockinfo_tmp.deserialize(i)
              @TopData << blockinfo_tmp
            end
          end
          @Total = params['Total']
      ...
      class DescribeClusterVpcFwSwitchsResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Total, :Data, :FailData, :RequestId

        def initialize(total=nil, data=nil, faildata=nil, requestid=nil)
          @Total = total
          @Data = data
          @FailData = faildata
          @RequestId = requestid
        ...
        def deserialize(params)
          ...
          unless params['FailData'].nil?
            ...
            params['FailData'].each do |i|
              switchfailinfo_tmp = SwitchFailInfo.new
              switchfailinfo_tmp.deserialize(i)
              @FailData << switchfailinfo_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class DescribeFwGroupIdNamesRequest < TencentCloud::Common::AbstractModel
        # @param IpVersion: <p>Ip版本，0：IPv4，1：IPv6，默认为IPv4</p>
        # @type IpVersion: Integer

        attr_accessor :IpVersion

        def initialize(ipversion=nil)
          @IpVersion = ipversion
        end
      ...
      class DescribeFwGroupIdNamesResponse < TencentCloud::Common::AbstractModel
        # @param Data: <p>防火墙(组列表)</p>
        # 注意：此字段可能返回 null，表示取不到有效值。
        # @type Data: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
        ...
        def deserialize(params)
          unless params['Data'].nil?
            @Data = []
            params['Data'].each do |i|
              fwgroupidname_tmp = FwGroupIdName.new
              fwgroupidname_tmp.deserialize(i)
              @Data << fwgroupidname_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class DescribeIpsRuleListNewRequest < TencentCloud::Common::AbstractModel
        ...
        def initialize(limit=nil, offset=nil, index=nil, filters=nil, order=nil, by=nil)
          @Limit = limit
          @Offset = offset
          @Index = index
          @Filters = filters
      ...
      class DescribeIpsRuleListNewResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Total, :Data, :ReturnCode, :ReturnMsg, :Category, :RequestId

        def initialize(total=nil, data=nil, returncode=nil, returnmsg=nil, category=nil, requestid=nil)
          @Total = total
          @Data = data
          @ReturnCode = returncode
          @ReturnMsg = returnmsg
        ...
        def deserialize(params)
          ...
          unless params['Data'].nil?
            @Data = []
            params['Data'].each do |i|
              ipsruledetailnew_tmp = IpsRuleDetailNew.new
              ipsruledetailnew_tmp.deserialize(i)
              @Data << ipsruledetailnew_tmp
            end
          end
          @ReturnCode = params['ReturnCode']
          @ReturnMsg = params['ReturnMsg']
      ...
      class DescribeNatFwInstanceResponse < TencentCloud::Common::AbstractModel
        ...
        # @type NatClusterLst: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :NatinsLst, :NatClusterLst, :RequestId

        def initialize(natinslst=nil, natclusterlst=nil, requestid=nil)
          @NatinsLst = natinslst
          @NatClusterLst = natclusterlst
          @RequestId = requestid
        end
        ...
        def deserialize(params)
          ...
          unless params['NatClusterLst'].nil?
            @NatClusterLst = []
            params['NatClusterLst'].each do |i|
              natclusterinfo_tmp = NatClusterInfo.new
              natclusterinfo_tmp.deserialize(i)
              @NatClusterLst << natclusterinfo_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class DescribeNatRuleScopesRequest < TencentCloud::Common::AbstractModel
      ...
      class DescribeNatRuleScopesResponse < TencentCloud::Common::AbstractModel
        # @param Total: 可选生效范围总数
        # @type Total: Integer
        # @param ScopeItems: 生效范围列表
        # 注意：此字段可能返回 null，表示取不到有效值。
        # @type ScopeItems: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :Total, :ScopeItems, :RequestId

        def initialize(total=nil, scopeitems=nil, requestid=nil)
          @Total = total
        ...
        def deserialize(params)
          @Total = params['Total']
          unless params['ScopeItems'].nil?
            @ScopeItems = []
            params['ScopeItems'].each do |i|
              rulescopeinfo_tmp = RuleScopeInfo.new
              rulescopeinfo_tmp.deserialize(i)
              @ScopeItems << rulescopeinfo_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class DescribeSecurityGroupRegionListRequest < TencentCloud::Common::AbstractModel
      ...
      class DescribeSecurityGroupRegionListResponse < TencentCloud::Common::AbstractModel
        # @param Data: <p>配置信息</p>
        # @type Data: Array
        # @param Total: <p>总数</p>
        # @type Total: Integer
        ...
        def deserialize(params)
          unless params['Data'].nil?
            @Data = []
            params['Data'].each do |i|
              securitygroupregion_tmp = SecurityGroupRegion.new
              securitygroupregion_tmp.deserialize(i)
              @Data << securitygroupregion_tmp
            end
          end
          @Total = params['Total']
          @RequestId = params['RequestId']
      ...
      class DescribeVpcAclEdgeRangeRequest < TencentCloud::Common::AbstractModel
        # @param FromList: 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
        ...
        attr_accessor :FromList, :Index, :Filters, :Limit, :Offset, :StartTime, :EndTime, :Order, :By

        def initialize(fromlist=nil, index=nil, filters=nil, limit=nil, offset=nil, starttime=nil, endtime=nil, order=nil, by=nil)
          @FromList = fromlist
          @Index = index
          @Filters = filters
          @Limit = limit
      ...
      class DescribeVpcAclEdgeRangeResponse < TencentCloud::Common::AbstractModel
        # @param TotalCount: 总条数
        # @type TotalCount: Integer
        # @param EdgeRanges: 内网间访问控制规则的生效范围列表
        # @type EdgeRanges: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :TotalCount, :EdgeRanges, :RequestId

        def initialize(totalcount=nil, edgeranges=nil, requestid=nil)
          @TotalCount = totalcount
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          unless params['EdgeRanges'].nil?
            @EdgeRanges = []
            params['EdgeRanges'].each do |i|
              edgerange_tmp = EdgeRange.new
              edgerange_tmp.deserialize(i)
              @EdgeRanges << edgerange_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      # vpc间防火墙规则生效范围列表
      class EdgeRange < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :EdgeId, :EdgeName, :SrcId, :SrcRegion, :SrcName, :SrcCidr, :DstId, :DstRegion, :DstName, :DstCidr

        def initialize(edgeid=nil, edgename=nil, srcid=nil, srcregion=nil, srcname=nil, srccidr=nil, dstid=nil, dstregion=nil, dstname=nil, dstcidr=nil)
          @EdgeId = edgeid
          @EdgeName = edgename
          @SrcId = srcid
          @SrcRegion = srcregion
      ...
      # 防火墙(组)ID 和 名称
      class FwGroupIdName < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :FwGroupId, :FwGroupName

        def initialize(fwgroupid=nil, fwgroupname=nil)
          @FwGroupId = fwgroupid
      ...
      class ModifyEnterpriseSecurityGroupRuleRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ModifyType, :RuleUuid, :CfwAiAgentOperationSource, :Data, :Enable

        def initialize(modifytype=nil, ruleuuid=nil, cfwaiagentoperationsource=nil, data=nil, enable=nil)
      ...
      class ModifyEnterpriseSecurityGroupRuleResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :NewRuleUuid, :Status, :RequestId

        def initialize(newruleuuid=nil, status=nil, requestid=nil)
      ...
      class ModifyIsolateTableRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ButtonAction, :InstanceID, :CfwAiAgentOperationSource, :EndTime, :StartTime

        def initialize(buttonaction=nil, instanceid=nil, cfwaiagentoperationsource=nil, endtime=nil, starttime=nil)
      ...
      class ModifyVpcAcRuleResponse < TencentCloud::Common::AbstractModel
        # @param RuleUuids: 修改后的规则 ID 列表，成功时包含请求规则的 Uuid。
        # @type RuleUuids: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      class NatClusterInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :NatInsId, :NatInsName

        def initialize(natinsid=nil, natinsname=nil)
          @NatInsId = natinsid
      ...
      class RemoveEnterpriseSecurityGroupRuleRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :RemoveType, :RuleUuid, :CfwAiAgentOperationSource

        def initialize(removetype=nil, ruleuuid=nil, cfwaiagentoperationsource=nil)
      ...
      class RemoveVpcAcRuleResponse < TencentCloud::Common::AbstractModel
        # @param RuleUuids: 回显请求中的规则 ID 列表；全量删除返回 [-1]。
        # @type RuleUuids: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String
      ...
      # 规则生效范围信息
      class RuleScopeInfo < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Scope, :ScopeDesc

        def initialize(scope=nil, scopedesc=nil)
          @Scope = scope
          @ScopeDesc = scopedesc
        end
      ...
      # 安全组地域配置
      class SecurityGroupRegion < TencentCloud::Common::AbstractModel
        # @param Region: <p>地域</p>
        # @type Region: String
        ...
        attr_accessor :Region, :RegionId, :RegionName

        def initialize(region=nil, regionid=nil, regionname=nil)
          @Region = region
          @RegionId = regionid
          @RegionName = regionname
        end
      ...
      class SecurityGroupRule < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Description, :DestContent, :DestType, :OrderIndex, :RuleAction, :SourceContent, :SourceType, :Enable, :Id, :Port, :Protocol, :Scope, :ServiceTemplateId, :Uid

        def initialize(description=nil, destcontent=nil, desttype=nil, orderindex=nil, ruleaction=nil, sourcecontent=nil, sourcetype=nil, enable=nil, id=nil, port=nil, protocol=nil, scope=nil, servicetemplateid=nil, uid=nil)
          @Description = description
          @DestContent = destcontent
          @DestType = desttype
          @OrderIndex = orderindex
      ...
      class SecurityGroupSimplifyRule < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Description, :DestContent, :Protocol, :RuleUuid, :Scope, :Sequence, :SourceContent

        def initialize(description=nil, destcontent=nil, protocol=nil, ruleuuid=nil, scope=nil, sequence=nil, sourcecontent=nil)
          @Description = description
          @DestContent = destcontent
          @Protocol = protocol
          @RuleUuid = ruleuuid
      ...
      # 开关开启错误码数据
      class SwitchFailInfo < TencentCloud::Common::AbstractModel
        # @param Id: 自增唯一ID
        # @type Id: Integer
        # @param Name: 开关名称
        # @type Name: String
      ...
      class VpcRuleItem < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Description, :DestContent, :DestType, :EdgeId, :Enable, :OrderIndex, :Port, :Protocol, :RuleAction, :SourceContent, :SourceType, :BetaList, :CreateTime, :Deleted, :DestValueType, :DetectedTimes, :EdgeName, :FwGroupId, :FwGroupName, :InternalUuid, :Invalid, :IpVersion, :ParamTemplateId, :ParamTemplateName, :RulePartition, :SourceName, :TargetName, :UpdateTime, :Uuid

        def initialize(description=nil, destcontent=nil, desttype=nil, edgeid=nil, enable=nil, orderindex=nil, port=nil, protocol=nil, ruleaction=nil, sourcecontent=nil, sourcetype=nil, betalist=nil, createtime=nil, deleted=nil, destvaluetype=nil, detectedtimes=nil, edgename=nil, fwgroupid=nil, fwgroupname=nil, internaluuid=nil, invalid=nil, ipversion=nil, paramtemplateid=nil, paramtemplatename=nil, rulepartition=nil, sourcename=nil, targetname=nil, updatetime=nil, uuid=nil)
          @Description = description
          @DestContent = destcontent
          @DestType = desttype
          @EdgeId = edgeid
