  ...
  module Bh
    module V20230418
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::bh::V20230418::DescribeDeviceCountRequest`
        # @rtype: :class:`Tencentcloud::bh::V20230418::DescribeDeviceCountResponse`
        def DescribeDeviceCount(request)
          body = send_request('DescribeDeviceCount', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeDeviceCountResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::bh::V20230418::DescribeDeviceCountSummaryRequest`
        # @rtype: :class:`Tencentcloud::bh::V20230418::DescribeDeviceCountSummaryResponse`
        def DescribeDeviceCountSummary(request)
          body = send_request('DescribeDeviceCountSummary', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeDeviceCountSummaryResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
