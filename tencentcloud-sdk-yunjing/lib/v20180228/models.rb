    ...
    module V20180228
      ...
      class DescribeAccountStatisticsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          @AccountStatistics = params['AccountStatistics']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeBruteAttacksResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @BruteAttacks = params['BruteAttacks']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeComponentStatisticsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @ComponentStatistics = params['ComponentStatistics']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeHistoryAccountsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @HistoryAccounts = params['HistoryAccounts']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeImpactedHostsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @ImpactedHosts = params['ImpactedHosts']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeLoginWhiteListResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @LoginWhiteLists = params['LoginWhiteLists']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeNonlocalLoginPlacesResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @NonLocalLoginPlaces = params['NonLocalLoginPlaces']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeOpenPortStatisticsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @OpenPortStatistics = params['OpenPortStatistics']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeProcessStatisticsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TotalCount = params['TotalCount']
          @ProcessStatistics = params['ProcessStatistics']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeSecurityDynamicsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @SecurityDynamics = params['SecurityDynamics']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeSecurityTrendsResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Malwares, :NonLocalLoginPlaces, :BruteAttacks, :Vuls, :BaseLines, :RequestId
        
        def initialize(malwares=nil, nonlocalloginplaces=nil, bruteattacks=nil, vuls=nil, baselines=nil, requestid=nil)
          @Malwares = malwares
          @NonLocalLoginPlaces = nonlocalloginplaces
          @BruteAttacks = bruteattacks
          @Vuls = vuls
      ...
      class DescribeUsualLoginPlacesResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @UsualLoginPlaces = params['UsualLoginPlaces']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWeeklyReportBruteAttacksResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @WeeklyReportBruteAttacks = params['WeeklyReportBruteAttacks']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWeeklyReportMalwaresResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @WeeklyReportMalwares = params['WeeklyReportMalwares']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWeeklyReportNonlocalLoginPlacesResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @WeeklyReportNonlocalLoginPlaces = params['WeeklyReportNonlocalLoginPlaces']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWeeklyReportVulsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @WeeklyReportVuls = params['WeeklyReportVuls']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class DescribeWeeklyReportsResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @WeeklyReports = params['WeeklyReports']
          @TotalCount = params['TotalCount']
          @RequestId = params['RequestId']
        end
      end
      ...
      class LoginWhiteLists < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Id, :Uuid, :Places, :UserName, :SrcIp, :IsGlobal, :CreateTime, :ModifyTime, :MachineName, :HostIp
        
        def initialize(id=nil, uuid=nil, places=nil, username=nil, srcip=nil, isglobal=nil, createtime=nil, modifytime=nil, machinename=nil, hostip=nil)
          @Id = id
          @Uuid = uuid
          @Places = places
          @UserName = username
      ...
      class LoginWhiteListsRule < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Places, :SrcIp, :UserName, :IsGlobal, :HostIp, :Id
        
        def initialize(places=nil, srcip=nil, username=nil, isglobal=nil, hostip=nil, id=nil)
          @Places = places
          @SrcIp = srcip
          @UserName = username
          @IsGlobal = isglobal
      ...
      class Machine < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :MachineName, :MachineOs, :MachineStatus, :Uuid, :Quuid, :VulNum, :MachineIp, :IsProVersion, :MachineWanIp, :PayMode, :MalwareNum, :Tag
        
        def initialize(machinename=nil, machineos=nil, machinestatus=nil, uuid=nil, quuid=nil, vulnum=nil, machineip=nil, isproversion=nil, machinewanip=nil, paymode=nil, malwarenum=nil, tag=nil)
          @MachineName = machinename
          @MachineOs = machineos
          @MachineStatus = machinestatus
          @Uuid = uuid
      ...
      class MachineTag < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Rid, :Name
        
        def initialize(rid=nil, name=nil)
          @Rid = rid
          @Name = name
        end
      ...
      class SecurityDynamic < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Uuid, :EventTime, :EventType, :Message
        
        def initialize(uuid=nil, eventtime=nil, eventtype=nil, message=nil)
          @Uuid = uuid
          @EventTime = eventtime
          @EventType = eventtype
          @Message = message
