  ...
  module Cngw
    module V20230418
      ...
      class AIGWAuthModelScopeItem < TencentCloud::Common::AbstractModel
        ...
        # @type ModelScope: :class:`Tencentcloud::Cngw.v20230418.models.AIGWModelScope`
      ...
      # 缓存感知路由
      class AIGWCacheAwareRouteConfig < TencentCloud::Common::AbstractModel
        # @param Candidates: <p>前缀缓存感知路由模型服务列表</p>
        ...
        def deserialize(params)
          unless params['Candidates'].nil?
            ...
            params['Candidates'].each do |i|
              aigwcacheawareroutecandidate_tmp = AIGWCacheAwareRouteCandidate.new
              aigwcacheawareroutecandidate_tmp.deserialize(i)
              @Candidates << aigwcacheawareroutecandidate_tmp
            end
          end
        end
      end
      ...
      # JWT 认证插件配置
      class AIGWJWTAuthPluginConfig < TencentCloud::Common::AbstractModel
        # @param HeaderNames: <p>签名的header名称列表</p>
        # @type HeaderNames: Array
        # @param CookieNames: <p>签名的cookie名称列表</p>
        # @type CookieNames: Array
        # @param URIParamNames: <p>签名的URL参数名称列表</p>
        # @type URIParamNames: Array
        # @param KeyClaimName: <p>消费者标识</p>
        # @type KeyClaimName: String
        # @param ClaimsToVerify: <p>标准消费者校验</p><p>枚举值：</p><ul><li>exp： exp</li><li>nbf： nbf</li></ul>
        # @type ClaimsToVerify: Array
        # @param MaximumExpiration: <p>最大有效期</p>
        # @type MaximumExpiration: Integer
        # @param SecretIsBase64: <p>是否Base64编码</p>
        # @type SecretIsBase64: Boolean
        # @param RunOnPreFlight: <p>CORS预检验证</p>
        # @type RunOnPreFlight: Boolean

        attr_accessor :HeaderNames, :CookieNames, :URIParamNames, :KeyClaimName, :ClaimsToVerify, :MaximumExpiration, :SecretIsBase64, :RunOnPreFlight

        def initialize(headernames=nil, cookienames=nil, uriparamnames=nil, keyclaimname=nil, claimstoverify=nil, maximumexpiration=nil, secretisbase64=nil, runonpreflight=nil)
        ...
        def deserialize(params)
          ...
          @URIParamNames = params['URIParamNames']
          @KeyClaimName = params['KeyClaimName']
          @ClaimsToVerify = params['ClaimsToVerify']
          @MaximumExpiration = params['MaximumExpiration']
          @SecretIsBase64 = params['SecretIsBase64']
          @RunOnPreFlight = params['RunOnPreFlight']
        end
      end
      ...
      class AIGWLLMHealthCheckSetting < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :HealthCheckFailThreshold, :HealthCheckIntervalSecond, :HealthCheckRecoverThreshold, :HealthCheckTimeout, :HealthCheckPath

        def initialize(healthcheckfailthreshold=nil, healthcheckintervalsecond=nil, healthcheckrecoverthreshold=nil, healthchecktimeout=nil, healthcheckpath=nil)
          @HealthCheckFailThreshold = healthcheckfailthreshold
          @HealthCheckIntervalSecond = healthcheckintervalsecond
          @HealthCheckRecoverThreshold = healthcheckrecoverthreshold
          @HealthCheckTimeout = healthchecktimeout
      ...
      class AIGWLLMModelServiceSubRoute < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SelectedTypes, :WeightedConfig, :LatencyPriorityConfig, :ModelServiceConfig

        def initialize(selectedtypes=nil, weightedconfig=nil, latencypriorityconfig=nil, modelserviceconfig=nil)
        ...
        def deserialize(params)
          ...
          unless params['ModelServiceConfig'].nil?
            @ModelServiceConfig = AIGWRouteModelServiceConfig.new
            @ModelServiceConfig.deserialize(params['ModelServiceConfig'])
          end
        end
      end
      ...
      class AIGWMCPServer < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ServerId, :Name, :ServerType, :Transport, :UpstreamType, :DisplayName, :MCPEndpoint, :UpstreamInfo, :SessionConfig, :Timeout, :RetryCount, :CreateTime, :UpdateTime, :Description, :Status, :EnableHealthCheck, :HealthCheck, :ToolCountLimit, :ConflictStrategy, :MarketStatus, :PreserveHost, :LogConfig

        def initialize(serverid=nil, name=nil, servertype=nil, transport=nil, upstreamtype=nil, displayname=nil, mcpendpoint=nil, upstreaminfo=nil, sessionconfig=nil, timeout=nil, retrycount=nil, createtime=nil, updatetime=nil, description=nil, status=nil, enablehealthcheck=nil, healthcheck=nil, toolcountlimit=nil, conflictstrategy=nil, marketstatus=nil, preservehost=nil, logconfig=nil)
          @ServerId = serverid
          @Name = name
      ...
      class AIGWMCPServerAuthResult < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AuthType, :JWTAuthConfig, :OAuthAuthConfig, :OIDCAuthConfig

        def initialize(authtype=nil, jwtauthconfig=nil, oauthauthconfig=nil, oidcauthconfig=nil)
          @AuthType = authtype
        ...
        def deserialize(params)
          @AuthType = params['AuthType']
          unless params['JWTAuthConfig'].nil?
            @JWTAuthConfig = AIGWJWTAuthPluginConfig.new
            @JWTAuthConfig.deserialize(params['JWTAuthConfig'])
          end
          unless params['OAuthAuthConfig'].nil?
            @OAuthAuthConfig = AIGWOAuthAuthPluginConfig.new
            @OAuthAuthConfig.deserialize(params['OAuthAuthConfig'])
          end
          unless params['OIDCAuthConfig'].nil?
            @OIDCAuthConfig = AIGWOIDCAuthPluginConfig.new
            @OIDCAuthConfig.deserialize(params['OIDCAuthConfig'])
          end
        end
      end
      ...
      class AIGWMCPUpstreamInfo < TencentCloud::Common::AbstractModel
        ...
        # @type TLSConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWUpstreamTLSConfig`

        attr_accessor :SourceId, :Namespace, :MCPServerId, :Protocol, :Host, :Port, :ServiceId, :ServiceGroup, :MCPEndpoint, :MessageEndpoint, :TLSConfig

        def initialize(sourceid=nil, namespace=nil, mcpserverid=nil, protocol=nil, host=nil, port=nil, serviceid=nil, servicegroup=nil, mcpendpoint=nil, messageendpoint=nil, tlsconfig=nil)
          @SourceId = sourceid
          @Namespace = namespace
        ...
        def deserialize(params)
          ...
          unless params['TLSConfig'].nil?
            @TLSConfig = AIGWUpstreamTLSConfig.new
      ...
      class AIGWMCPUpstreamInfoDetail < TencentCloud::Common::AbstractModel
        ...
        # @type MessageEndpoint: String
        # @param TLSConfig: <p>TLS配置</p>
        # @type TLSConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWUpstreamTLSConfig`

        attr_accessor :SourceId, :SourceName, :Namespace, :MCPServerId, :Protocol, :Host, :Port, :ServiceId, :ServiceName, :ServiceGroup, :MCPEndpoint, :MessageEndpoint, :TLSConfig

        def initialize(sourceid=nil, sourcename=nil, namespace=nil, mcpserverid=nil, protocol=nil, host=nil, port=nil, serviceid=nil, servicename=nil, servicegroup=nil, mcpendpoint=nil, messageendpoint=nil, tlsconfig=nil)
          @SourceId = sourceid
      ...
      # 模型名字重写规则
      class AIGWModelRewriteRule < TencentCloud::Common::AbstractModel
      ...
      # 资源端 OAuth2 认证插件配置
      class AIGWOAuthAuthPluginConfig < TencentCloud::Common::AbstractModel
        # @param HeaderNames: <p>取token的头部名称</p>
        # @type HeaderNames: Array
        # @param TokenExpiration: <p>过期时间</p>
        # @type TokenExpiration: Integer
        # @param Scopes: <p>授权范围</p>
        # @type Scopes: Array
        # @param MandatoryScope: <p>是否强制判断授权范围</p>
        # @type MandatoryScope: Boolean

        attr_accessor :HeaderNames, :TokenExpiration, :Scopes, :MandatoryScope

        def initialize(headernames=nil, tokenexpiration=nil, scopes=nil, mandatoryscope=nil)
          @HeaderNames = headernames
        ...
        def deserialize(params)
          ...
          @MandatoryScope = params['MandatoryScope']
        end
      end
      ...
      # 资源端 OIDC 认证插件配置
      class AIGWOIDCAuthPluginConfig < TencentCloud::Common::AbstractModel
        # @param Audience: <p>目标受众</p>
        # @type Audience: String
        # @param BearerOnly: <p>是否BearerOnly</p><p>目前只能为true</p>
        # @type BearerOnly: Boolean
        # @param Scopes: <p>授权范围</p>
        # @type Scopes: Array
        # @param ConsumerClaim: <p>消费者标识</p>
        # @type ConsumerClaim: String
        # @param Realm: <p>认证域</p>
        # @type Realm: String
        ...
        # @type IntrospectionEndpoint: String
        ...
        attr_accessor :Audience, :BearerOnly, :Scopes, :ConsumerClaim, :Realm, :Timeout, :TokenEndpointAuthMethod, :IntrospectionEndpoint, :IntrospectionEndpointAuthMethod, :IssuerURL, :ClientId, :ClientSecret

        def initialize(audience=nil, beareronly=nil, scopes=nil, consumerclaim=nil, realm=nil, timeout=nil, tokenendpointauthmethod=nil, introspectionendpoint=nil, introspectionendpointauthmethod=nil, issuerurl=nil, clientid=nil, clientsecret=nil)
          @Audience = audience
        ...
        def deserialize(params)
          ...
          @BearerOnly = params['BearerOnly']
          @Scopes = params['Scopes']
          @ConsumerClaim = params['ConsumerClaim']
          @Realm = params['Realm']
          @Timeout = params['Timeout']
          @TokenEndpointAuthMethod = params['TokenEndpointAuthMethod']
          @IntrospectionEndpoint = params['IntrospectionEndpoint']
          @IntrospectionEndpointAuthMethod = params['IntrospectionEndpointAuthMethod']
      ...
      class AIGWOIDCCredentialConfig < TencentCloud::Common::AbstractModel
        ...
        # @type ConsumerClaimValue: String

        attr_accessor :ClientId, :ClientSecret, :IssuerURL, :ConsumerClaimValue

        def initialize(clientid=nil, clientsecret=nil, issuerurl=nil, consumerclaimvalue=nil)
          @ClientId = clientid
          @ClientSecret = clientsecret
          @IssuerURL = issuerurl
          @ConsumerClaimValue = consumerclaimvalue
        end
        ...
        def deserialize(params)
          ...
          @ClientSecret = params['ClientSecret']
          @IssuerURL = params['IssuerURL']
          @ConsumerClaimValue = params['ConsumerClaimValue']
        end
      end
      ...
      class AIGWRouteModelServiceConfig < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :ModelServiceName

        def initialize(modelservicename=nil)
          @ModelServiceName = modelservicename
        end
      ...
      # 简单密钥信息
      class AIGWSimpleSecretKey < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SecretKeyId, :Name, :Status, :SecretType, :CreateTime

        def initialize(secretkeyid=nil, name=nil, status=nil, secrettype=nil, createtime=nil)
      ...
      # AI 网关token长度路由配置
      class AIGWTokenLengthRoute < TencentCloud::Common::AbstractModel
        ...
        # @type DefaultEncodingName: String
        ...
        attr_accessor :DefaultEncodingName, :DefaultTarget, :Rules

        def initialize(defaultencodingname=nil, defaulttarget=nil, rules=nil)
        ...
        def deserialize(params)
          @DefaultEncodingName = params['DefaultEncodingName']
          unless params['DefaultTarget'].nil?
            @DefaultTarget = AIGWLLMModelServiceSubRoute.new
            @DefaultTarget.deserialize(params['DefaultTarget'])
          end
          unless params['Rules'].nil?
            @Rules = []
            params['Rules'].each do |i|
              aigwtokenlengthrouterule_tmp = AIGWTokenLengthRouteRule.new
              aigwtokenlengthrouterule_tmp.deserialize(i)
              @Rules << aigwtokenlengthrouterule_tmp
            end
          end
        end
      end
      ...
      # AI 网关Token长度路由规则
      class AIGWTokenLengthRouteRule < TencentCloud::Common::AbstractModel
        # @param MinTokenLength: <p>token 长度下界，闭区间；0 合法</p>
        # @type MinTokenLength: Integer
        # @param MaxTokenLength: <p>token 长度上界，闭区间</p>
        # @type MaxTokenLength: Integer
        # @param Target: <p>命中该分段后执行的二级路由</p>
        # @type Target: :class:`Tencentcloud::Cngw.v20230418.models.AIGWLLMModelServiceSubRoute`

        attr_accessor :MinTokenLength, :MaxTokenLength, :Target

        def initialize(mintokenlength=nil, maxtokenlength=nil, target=nil)
        ...
        def deserialize(params)
          ...
          unless params['Target'].nil?
            @Target = AIGWLLMModelServiceSubRoute.new
      ...
      # AI网关Upstream TLS配置
      class AIGWUpstreamTLSConfig < TencentCloud::Common::AbstractModel
        # @param TLSVerify: <p>是否校验上游服务端证书</p><p>默认值：false</p>
        # @type TLSVerify: Boolean
        # @param ClientCertId: <p>客户端证书 ID（mTLS 用）</p>
        # @type ClientCertId: String
        # @param UpstreamCACertIds: <p>信任的 CA 证书 ID 列表</p>
        # @type UpstreamCACertIds: Array

        attr_accessor :TLSVerify, :ClientCertId, :UpstreamCACertIds

        def initialize(tlsverify=nil, clientcertid=nil, upstreamcacertids=nil)
          @TLSVerify = tlsverify
          @ClientCertId = clientcertid
          @UpstreamCACertIds = upstreamcacertids
        end

        def deserialize(params)
          @TLSVerify = params['TLSVerify']
          @ClientCertId = params['ClientCertId']
          @UpstreamCACertIds = params['UpstreamCACertIds']
        end
      end
      ...
      class CNAPIGwConsumerGroup < TencentCloud::Common::AbstractModel
        ...
        # @param SyncStatus: <p>同步状态</p><p>枚举值：</p><ul><li>Fail： 失败</li><li>Succes： 成功</li></ul>
        # @type SyncStatus: String
        # @param SourceType: <p>资源类型</p><p>枚举值：</p><ul><li>Public： 公共</li><li>Private： 私有</li><li>SourceDeleted： 资源已删除</li></ul>
        # @type SourceType: String
        # @param SyncedVersion: <p>同步版本</p>
        # @type SyncedVersion: String
      ...
      class CNAPIGwSecretKey < TencentCloud::Common::AbstractModel
        ...
        # @type AKSKCredentialConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWAKSKCredentialConfig`
        # @param CAMCredentialConfig: <p>CAM凭证配置</p>
        # @type CAMCredentialConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWCAMCredentialConfig`
        # @param BearerTokenCredentialConfig: <p>Bearer Token凭证配置</p>
        # @type BearerTokenCredentialConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWBearerTokenCredentialConfig`
        # @param BasicCredentialConfig: <p>Basic Auth凭证配置</p>
        # @type BasicCredentialConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWBasicCredentialConfig`
        ...
        # @type BoundModelSecretKeys: Array
        # @param BoundConsumerSecretKeys: <p>绑定了该模型密钥的消费者密钥列表</p>
        # @type BoundConsumerSecretKeys: Array

        attr_accessor :BindCount, :CanBind, :CreateTime, :Description, :GenerateType, :JWTCredentialConfig, :KmsKeyName, :KmsKeyVersion, :ModifyTime, :Name, :OAuthCredentialConfig, :OIDCCredentialConfig, :Provider, :ResourceType, :SecretKeyId, :SecretType, :SecretValue, :Status, :SyncStatus, :SourceType, :SyncedVersion, :AKSKCredentialConfig, :CAMCredentialConfig, :BearerTokenCredentialConfig, :BasicCredentialConfig, :CustomHeaderCredentialConfig, :QueryParamCredentialConfig, :BoundModelSecretKeys, :BoundConsumerSecretKeys

        def initialize(bindcount=nil, canbind=nil, createtime=nil, description=nil, generatetype=nil, jwtcredentialconfig=nil, kmskeyname=nil, kmskeyversion=nil, modifytime=nil, name=nil, oauthcredentialconfig=nil, oidccredentialconfig=nil, provider=nil, resourcetype=nil, secretkeyid=nil, secrettype=nil, secretvalue=nil, status=nil, syncstatus=nil, sourcetype=nil, syncedversion=nil, akskcredentialconfig=nil, camcredentialconfig=nil, bearertokencredentialconfig=nil, basiccredentialconfig=nil, customheadercredentialconfig=nil, queryparamcredentialconfig=nil, boundmodelsecretkeys=nil, boundconsumersecretkeys=nil)
          @BindCount = bindcount
          @CanBind = canbind
          @CreateTime = createtime
          @Description = description
          ...
          @BoundModelSecretKeys = boundmodelsecretkeys
          @BoundConsumerSecretKeys = boundconsumersecretkeys
        end
        ...
        def deserialize(params)
          ...
          unless params['BoundModelSecretKeys'].nil?
            @BoundModelSecretKeys = []
            params['BoundModelSecretKeys'].each do |i|
              aigwsimplesecretkey_tmp = AIGWSimpleSecretKey.new
              aigwsimplesecretkey_tmp.deserialize(i)
              @BoundModelSecretKeys << aigwsimplesecretkey_tmp
            end
          end
          unless params['BoundConsumerSecretKeys'].nil?
            @BoundConsumerSecretKeys = []
            params['BoundConsumerSecretKeys'].each do |i|
              aigwsimplesecretkey_tmp = AIGWSimpleSecretKey.new
              aigwsimplesecretkey_tmp.deserialize(i)
              @BoundConsumerSecretKeys << aigwsimplesecretkey_tmp
            end
          end
        end
      end
      ...
      class CloudNativeAPIGatewayLLMModelAPI < TencentCloud::Common::AbstractModel
        ...
        # @type MaxDocumentsConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWRerankMaxDocumentsConfig`
        # @param SensitiveWordRoute: <p>敏感词路由配置</p>
        # @type SensitiveWordRoute: :class:`Tencentcloud::Cngw.v20230418.models.AIGWSensitiveWordRoute`
        ...
        # @type ConsumerInheritModelScope: :class:`Tencentcloud::Cngw.v20230418.models.AIGWConsumerModelScope`
      ...
      class CloudNativeAPIGatewayLLMModelService < TencentCloud::Common::AbstractModel
        ...
        # @type ModelRewriteRules: Array
        # @param SourceId: <p>服务来源</p>
        # @type SourceId: String
        # @param Namespace: <p>命名空间</p>
        # @type Namespace: String
        # @param ServiceName: <p>服务名称</p>
        # @type ServiceName: String
        # @param Protocol: <p>命名空间</p>
        # @type Protocol: String
        ...
        # @param KeyRotationPeriodDays: <p>密钥轮转周期</p><p>单位：天</p>
        ...
        # @type LoadBalanceConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWLoadBalanceConfig`
        # @param CanPublish: <p>是否可以发布到广场</p>
        # @type CanPublish: Boolean
        # @param PublishStatus: <p>发布状态</p><p>枚举值：</p><ul><li>Unpublished： 未发布</li><li>Published： 已发布</li></ul>
        ...
        def deserialize(params)
          ...
          unless params['ModelRewriteRules'].nil?
            @ModelRewriteRules = []
            params['ModelRewriteRules'].each do |i|
              aigwmodelrewriterule_tmp = AIGWModelRewriteRule.new
              aigwmodelrewriterule_tmp.deserialize(i)
              @ModelRewriteRules << aigwmodelrewriterule_tmp
            end
          end
          @SourceId = params['SourceId']
          @Namespace = params['Namespace']
      ...
      class CloudNativeAPIGatewayLLMModelServiceRoute < TencentCloud::Common::AbstractModel
        ...
        # @param LatencyPriorityConfig: <p>延迟路由</p>
        # @type LatencyPriorityConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWLatencyPriorityConfig`
        # @param CacheAwareRouteConfig: <p>前缀缓存感知路由</p>
        # @type CacheAwareRouteConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWCacheAwareRouteConfig`
        # @param TokenLengthRouteConfig: <p>token 长度路</p>
        # @type TokenLengthRouteConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWTokenLengthRoute`

        attr_accessor :SelectedTypes, :WeightedConfig, :ModelNameConfig, :IntentRouteConfig, :LatencyPriorityConfig, :CacheAwareRouteConfig, :TokenLengthRouteConfig

        def initialize(selectedtypes=nil, weightedconfig=nil, modelnameconfig=nil, intentrouteconfig=nil, latencypriorityconfig=nil, cacheawarerouteconfig=nil, tokenlengthrouteconfig=nil)
          @SelectedTypes = selectedtypes
          @WeightedConfig = weightedconfig
          @ModelNameConfig = modelnameconfig
          @IntentRouteConfig = intentrouteconfig
          @LatencyPriorityConfig = latencypriorityconfig
          @CacheAwareRouteConfig = cacheawarerouteconfig
          @TokenLengthRouteConfig = tokenlengthrouteconfig
        end
        ...
        def deserialize(params)
          ...
          unless params['CacheAwareRouteConfig'].nil?
            @CacheAwareRouteConfig = AIGWCacheAwareRouteConfig.new
            @CacheAwareRouteConfig.deserialize(params['CacheAwareRouteConfig'])
          end
          unless params['TokenLengthRouteConfig'].nil?
            @TokenLengthRouteConfig = AIGWTokenLengthRoute.new
            @TokenLengthRouteConfig.deserialize(params['TokenLengthRouteConfig'])
          end
        end
      end
      ...
      class CreateCloudNativeAPIGatewayMCPServerRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :Name, :DisplayName, :ServerType, :Transport, :UpstreamType, :UpstreamInfo, :SessionConfig, :Timeout, :RetryCount, :Description, :EnableHealthCheck, :HealthCheck, :PreserveHost, :LogConfig

        def initialize(gatewayid=nil, name=nil, displayname=nil, servertype=nil, transport=nil, upstreamtype=nil, upstreaminfo=nil, sessionconfig=nil, timeout=nil, retrycount=nil, description=nil, enablehealthcheck=nil, healthcheck=nil, preservehost=nil, logconfig=nil)
          @GatewayId = gatewayid
          @Name = name
          @DisplayName = displayname
          @ServerType = servertype
      ...
      class CreateCloudNativeAPIGatewaySecretKeyRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :GenerateType, :Name, :ResourceType, :SecretType, :Description, :JWTCredentialConfig, :KmsKeyName, :KmsKeyVersion, :OAuthCredentialConfig, :OIDCCredentialConfig, :Provider, :SecretValue, :AKSKCredentialConfig, :CAMCredentialConfig, :BearerTokenCredentialConfig, :CustomHeaderCredentialConfig, :QueryParamCredentialConfig, :BasicCredentialConfig

        def initialize(gatewayid=nil, generatetype=nil, name=nil, resourcetype=nil, secrettype=nil, description=nil, jwtcredentialconfig=nil, kmskeyname=nil, kmskeyversion=nil, oauthcredentialconfig=nil, oidccredentialconfig=nil, provider=nil, secretvalue=nil, akskcredentialconfig=nil, camcredentialconfig=nil, bearertokencredentialconfig=nil, customheadercredentialconfig=nil, queryparamcredentialconfig=nil, basiccredentialconfig=nil)
          @GatewayId = gatewayid
          @GenerateType = generatetype
          @Name = name
          @ResourceType = resourcetype
      ...
      class DescribeCloudNativeAPIGatewayAIQuotaListRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :Offset, :Limit, :Keyword, :Filters, :AlarmLevels

        def initialize(gatewayid=nil, offset=nil, limit=nil, keyword=nil, filters=nil, alarmlevels=nil)
          @GatewayId = gatewayid
          @Offset = offset
          @Limit = limit
          @Keyword = keyword
      ...
      class DescribeCloudNativeAPIGatewayAIServiceSourceListRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :Limit, :Offset, :Keyword, :Filters

        def initialize(gatewayid=nil, limit=nil, offset=nil, keyword=nil, filters=nil)
          @GatewayId = gatewayid
          @Limit = limit
          @Offset = offset
          @Keyword = keyword
      ...
      class DescribeCloudNativeAPIGatewayMCPServerListRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :Limit, :Offset, :SecretKeyId

        def initialize(gatewayid=nil, limit=nil, offset=nil, secretkeyid=nil)
          @GatewayId = gatewayid
          @Limit = limit
          @Offset = offset
          @SecretKeyId = secretkeyid
      ...
      class DescribeCloudNativeAPIGatewaySecretKeyListRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :Limit, :Offset, :Filters, :Keyword, :ResourceId, :ResourceType, :UseToBind

        def initialize(gatewayid=nil, limit=nil, offset=nil, filters=nil, keyword=nil, resourceid=nil, resourcetype=nil, usetobind=nil)
          @GatewayId = gatewayid
          @Limit = limit
          @Offset = offset
          @Filters = filters
      ...
      class DescribeCloudNativeAPIGatewaySecretKeyValueRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :SecretKeyId, :SecretValueType

        def initialize(gatewayid=nil, secretkeyid=nil, secretvaluetype=nil)
          @GatewayId = gatewayid
          @SecretKeyId = secretkeyid
        ...
        def deserialize(params)
          @GatewayId = params['GatewayId']
          @SecretKeyId = params['SecretKeyId']
          @SecretValueType = params['SecretValueType']
        end
      end
      ...
      class ModifyCloudNativeAPIGatewayLLMModelAPIRequest < TencentCloud::Common::AbstractModel
        ...
        # @type LogConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWLogConfig`
        # @param MaxDocumentsConfig: <p>AI 网关Rerank场景最大文档数限制配置</p>
        # @type MaxDocumentsConfig: :class:`Tencentcloud::Cngw.v20230418.models.AIGWRerankMaxDocumentsConfig`
        # @param SensitiveWordRoute: <p>敏感词路由配置</p>
        # @type SensitiveWordRoute: :class:`Tencentcloud::Cngw.v20230418.models.AIGWSensitiveWordRoute`
      ...
      class ModifyCloudNativeAPIGatewayMCPServerAuthRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :ServerId, :AuthType, :JWTAuthConfig, :OAuthAuthConfig, :OIDCAuthConfig

        def initialize(gatewayid=nil, serverid=nil, authtype=nil, jwtauthconfig=nil, oauthauthconfig=nil, oidcauthconfig=nil)
          @GatewayId = gatewayid
          @ServerId = serverid
          @AuthType = authtype
          @JWTAuthConfig = jwtauthconfig
      ...
      class ModifyCloudNativeAPIGatewayMCPServerRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :GatewayId, :DisplayName, :ServerId, :UpstreamType, :Timeout, :RetryCount, :UpstreamInfo, :SessionConfig, :Description, :EnableHealthCheck, :HealthCheck, :PreserveHost, :LogConfig

        def initialize(gatewayid=nil, displayname=nil, serverid=nil, upstreamtype=nil, timeout=nil, retrycount=nil, upstreaminfo=nil, sessionconfig=nil, description=nil, enablehealthcheck=nil, healthcheck=nil, preservehost=nil, logconfig=nil)
          @GatewayId = gatewayid
          @DisplayName = displayname
          @ServerId = serverid
          @UpstreamType = upstreamtype
