...
module TencentCloud
  module Ccc
    module V20200210
      ...
      # 接口调用的单次尝试明细
      class AICallAPICallAttempt < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Index, :Timestamp, :Status, :StatusCode, :ErrorType, :Summary, :CostMS, :Request, :Response

        def initialize(index=nil, timestamp=nil, status=nil, statuscode=nil, errortype=nil, summary=nil, costms=nil, request=nil, response=nil)
          @Index = index
          @Timestamp = timestamp
          @Status = status
        ...
        def deserialize(params)
          ...
          unless params['Request'].nil?
            @Request = AICallAPICallRequestDetail.new
            @Request.deserialize(params['Request'])
          end
          unless params['Response'].nil?
            @Response = AICallAPICallResponseDetail.new
            @Response.deserialize(params['Response'])
          end
        end
      end

      # 接口调用节点的调用详情
      class AICallAPICallDetail < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Async, :Status, :StatusCode, :Summary, :CostMS, :RetryCount, :Attempts

        def initialize(async=nil, status=nil, statuscode=nil, summary=nil, costms=nil, retrycount=nil, attempts=nil)
          @Async = async
          @Status = status
          @StatusCode = statuscode
          @Summary = summary
        ...
        def deserialize(params)
          ...
          unless params['Attempts'].nil?
            @Attempts = []
            params['Attempts'].each do |i|
              aicallapicallattempt_tmp = AICallAPICallAttempt.new
              aicallapicallattempt_tmp.deserialize(i)
              @Attempts << aicallapicallattempt_tmp
            end
          end
        end
      end
      ...
      # 接口调用的请求详情
      class AICallAPICallRequestDetail < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Method, :URL, :Params, :Headers, :Body, :Truncated

        def initialize(method=nil, url=nil, params=nil, headers=nil, body=nil, truncated=nil)
          @Method = method
          @URL = url
          @Params = params
          @Headers = headers
      ...
      # 接口调用的响应详情
      class AICallAPICallResponseDetail < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :StatusCode, :Headers, :Body, :Truncated

        def initialize(statuscode=nil, headers=nil, body=nil, truncated=nil)
          @StatusCode = statuscode
          @Headers = headers
          @Body = body
          @Truncated = truncated
      ...
      class AIRoundPath < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :NodeName, :NodeType, :Timestamp, :APICall

        def initialize(nodename=nil, nodetype=nil, timestamp=nil, apicall=nil)
          @NodeName = nodename
          @NodeType = nodetype
          @Timestamp = timestamp
          @APICall = apicall
        ...
        def deserialize(params)
          ...
          @Timestamp = params['Timestamp']
          unless params['APICall'].nil?
            @APICall = AICallAPICallDetail.new
            @APICall.deserialize(params['APICall'])
          end
        end
      end
      ...
      class AISpeakEvent < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CanBeInterrupted, :SpokenText, :SpokenType, :LatencyMetrics, :KnowledgeName, :TraverseReason

        def initialize(canbeinterrupted=nil, spokentext=nil, spokentype=nil, latencymetrics=nil, knowledgename=nil, traversereason=nil)
      ...
      class AsrData < TencentCloud::Common::AbstractModel
        ...
        deprecate :Timestamp, :none, 2026, 9
        deprecate :Timestamp=, :none, 2026, 9
      ...
      class BindStaffSkillGroupListRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :SkillGroupList, :none, 2026, 9
        deprecate :SkillGroupList=, :none, 2026, 9
      ...
      class CreateAIAgentCallRequest < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :PromptVariables, :none, 2026, 9
        deprecate :PromptVariables=, :none, 2026, 9
      ...
      class CreateAutoCalloutTaskRequest < TencentCloud::Common::AbstractModel
        ...
        # @type ConcurrencyLimit: Integer

        attr_accessor :SdkAppId, :NotBefore, :Callees, :Callers, :IvrId, :Name, :Description, :NotAfter, :Tries, :Variables, :UUI, :CalleeAttributes, :TimeZone, :AvailableTime, :AIAgentId, :RetryInterval, :MaxRingTimeoutSecond, :RetryHangupTypes, :RetryTags, :AvailableWorkTimeConfig, :TriggerStrategy, :ConcurrencyLimit

        def initialize(sdkappid=nil, notbefore=nil, callees=nil, callers=nil, ivrid=nil, name=nil, description=nil, notafter=nil, tries=nil, variables=nil, uui=nil, calleeattributes=nil, timezone=nil, availabletime=nil, aiagentid=nil, retryinterval=nil, maxringtimeoutsecond=nil, retryhanguptypes=nil, retrytags=nil, availableworktimeconfig=nil, triggerstrategy=nil, concurrencylimit=nil)
          @SdkAppId = sdkappid
          @NotBefore = notbefore
          @Callees = callees
          @Callers = callers
      ...
      class CreateOwnNumberApplyRequest < TencentCloud::Common::AbstractModel
        ...
        # @type CalleeFormatPassthrough: Boolean
        # @param CallerFormatPassthrough: 主叫格式透传 （完成透传用户输入，不做处理）
        # @type CallerFormatPassthrough: Boolean
        # @param InternationalNumberPrefix: 国际长途前缀码
        # @type InternationalNumberPrefix: String

        attr_accessor :SdkAppId, :SipTrunkId, :DetailList, :Prefix, :MobileNddPrefix, :LocalNumberTrimAC, :CalleeFormatPassthrough, :CallerFormatPassthrough, :InternationalNumberPrefix

        def initialize(sdkappid=nil, siptrunkid=nil, detaillist=nil, prefix=nil, mobilenddprefix=nil, localnumbertrimac=nil, calleeformatpassthrough=nil, callerformatpassthrough=nil, internationalnumberprefix=nil)
          @SdkAppId = sdkappid
          ...
          @CalleeFormatPassthrough = calleeformatpassthrough
          @CallerFormatPassthrough = callerformatpassthrough
          @InternationalNumberPrefix = internationalnumberprefix
        end
        ...
        def deserialize(params)
          ...
          @CalleeFormatPassthrough = params['CalleeFormatPassthrough']
          @CallerFormatPassthrough = params['CallerFormatPassthrough']
          @InternationalNumberPrefix = params['InternationalNumberPrefix']
        end
      end
      ...
      class DescribePredictiveDialingCampaignResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :CampaignId, :Name, :CallOrder, :SkillGroupId, :IVRId, :Priority, :ExpectedAbandonRate, :RetryTimes, :RetryInterval, :StartTime, :EndTime, :Variables, :UUI, :Status, :StatusReason, :RequestId

        def initialize(campaignid=nil, name=nil, callorder=nil, skillgroupid=nil, ivrid=nil, priority=nil, expectedabandonrate=nil, retrytimes=nil, retryinterval=nil, starttime=nil, endtime=nil, variables=nil, uui=nil, status=nil, statusreason=nil, requestid=nil)
          @CampaignId = campaignid
          @Name = name
          @CallOrder = callorder
          @SkillGroupId = skillgroupid
      ...
      class DescribePredictiveDialingCampaignsRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SdkAppId, :PageSize, :PageNumber, :Name, :SkillGroupId, :CampaignId

        def initialize(sdkappid=nil, pagesize=nil, pagenumber=nil, name=nil, skillgroupid=nil, campaignid=nil)
          @SdkAppId = sdkappid
          @PageSize = pagesize
          @PageNumber = pagenumber
          @Name = name
      ...
      class DescribeTelCallInfoResponse < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :VoipCallInCount, :none, 2026, 9
        deprecate :VoipCallInCount=, :none, 2026, 9
      ...
      class DescribeTelCdrRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :InstanceId, :none, 2026, 9
        deprecate :InstanceId=, :none, 2026, 9
        deprecate :Limit, :none, 2026, 9
        deprecate :Limit=, :none, 2026, 9
        deprecate :Offset, :none, 2026, 9
        deprecate :Offset=, :none, 2026, 9
      ...
      class ModifyOwnNumberApplyRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :SdkAppId, :DetailList, :ApplyId, :Prefix, :MobileNddPrefix, :LocalNumberTrimAC, :CalleeFormatPassthrough, :CallerFormatPassthrough, :InternationalNumberPrefix

        def initialize(sdkappid=nil, detaillist=nil, applyid=nil, prefix=nil, mobilenddprefix=nil, localnumbertrimac=nil, calleeformatpassthrough=nil, callerformatpassthrough=nil, internationalnumberprefix=nil)
          @SdkAppId = sdkappid
          @DetailList = detaillist
          @ApplyId = applyid
          @Prefix = prefix
      ...
      class StaffInfo < TencentCloud::Common::AbstractModel
        ...
        extend Gem::Deprecate
        deprecate :RoleId, :none, 2026, 9
        deprecate :RoleId=, :none, 2026, 9
        deprecate :RoleIdList, :none, 2026, 9
        deprecate :RoleIdList=, :none, 2026, 9
      ...
      class TelCdrInfo < TencentCloud::Common::AbstractModel
        ...
        deprecate :IVRKeyPressed=, :none, 2026, 9
        deprecate :PostIVRKeyPressed, :none, 2026, 9
        deprecate :PostIVRKeyPressed=, :none, 2026, 9
        deprecate :Uui, :none, 2026, 9
        deprecate :Uui=, :none, 2026, 9
