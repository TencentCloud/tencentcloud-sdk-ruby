  ...
  module Iotcloud
    module V20180614
      ...
      class DescribeMultiDevicesResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          @TaskId = params['TaskId']
          @DevicesInfo = params['DevicesInfo']
      ...
      class PublishMessageRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Topic, :Payload, :ProductId, :DeviceName, :Qos
        
        def initialize(topic=nil, payload=nil, productid=nil, devicename=nil, qos=nil)
          @Topic = topic
          @Payload = payload
          @ProductId = productid
          @DeviceName = devicename
      ...
      class ResetDeviceStateResponse < TencentCloud::Common::AbstractModel
        ...
        def deserialize(params)
          ...
          @ResetDeviceResults = params['ResetDeviceResults']
          @RequestId = params['RequestId']
        end
      end
