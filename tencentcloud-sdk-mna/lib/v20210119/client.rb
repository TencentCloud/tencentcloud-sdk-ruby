  ...
  module Mna
    module V20210119
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::mna::V20210119::GetHardwareInfoRequest`
        # @rtype: :class:`Tencentcloud::mna::V20210119::GetHardwareInfoResponse`
        def GetHardwareInfo(request)
          body = send_request('GetHardwareInfo', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = GetHardwareInfoResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
