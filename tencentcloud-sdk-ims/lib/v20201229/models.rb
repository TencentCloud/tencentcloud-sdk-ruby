  ...
  module Ims
    module V20201229
      ...
      class ImageModerationRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :BizType, :DataId, :FileContent, :FileUrl, :Interval, :MaxFrames, :User, :Device, :Type, :BizTag

        def initialize(biztype=nil, dataid=nil, filecontent=nil, fileurl=nil, interval=nil, maxframes=nil, user=nil, device=nil, type=nil, biztag=nil)
          @BizType = biztype
          @DataId = dataid
          @FileContent = filecontent
          @FileUrl = fileurl
