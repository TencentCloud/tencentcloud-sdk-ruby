  ...
  module Mqtt
    module V20240516
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::mqtt::V20240516::DescribeSharedSubscriptionGroupsRequest`
        # @rtype: :class:`Tencentcloud::mqtt::V20240516::DescribeSharedSubscriptionGroupsResponse`
        def DescribeSharedSubscriptionGroups(request)
          body = send_request('DescribeSharedSubscriptionGroups', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribeSharedSubscriptionGroupsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
