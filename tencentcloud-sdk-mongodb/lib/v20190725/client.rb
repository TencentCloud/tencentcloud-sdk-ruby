  ...
  module Mongodb
    module V20190725
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::mongodb::V20190725::CheckDBInstanceElasticCpuScalableRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::CheckDBInstanceElasticCpuScalableResponse`
        def CheckDBInstanceElasticCpuScalable(request)
          body = send_request('CheckDBInstanceElasticCpuScalable', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CheckDBInstanceElasticCpuScalableResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @param request: Request instance for CreateSlowLogPatternDownloadTask.
        # @type request: :class:`Tencentcloud::mongodb::V20190725::CreateSlowLogPatternDownloadTaskRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::CreateSlowLogPatternDownloadTaskResponse`
        def CreateSlowLogPatternDownloadTask(request)
          body = send_request('CreateSlowLogPatternDownloadTask', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateSlowLogPatternDownloadTaskResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::mongodb::V20190725::DescribeDBInstanceLogToCLSRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::DescribeDBInstanceLogToCLSResponse`
        ...
        # @param request: Request instance for EnableWanService.
        # @type request: :class:`Tencentcloud::mongodb::V20190725::EnableWanServiceRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::EnableWanServiceResponse`
        def EnableWanService(request)
          body = send_request('EnableWanService', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = EnableWanServiceResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @param request: Request instance for IncreaseDBInstanceConnectionLimit.
        # @type request: :class:`Tencentcloud::mongodb::V20190725::IncreaseDBInstanceConnectionLimitRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::IncreaseDBInstanceConnectionLimitResponse`
        def IncreaseDBInstanceConnectionLimit(request)
          body = send_request('IncreaseDBInstanceConnectionLimit', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = IncreaseDBInstanceConnectionLimitResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::mongodb::V20190725::ModifyDBInstanceLogToCLSRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::ModifyDBInstanceLogToCLSResponse`
        ...
        # @type request: :class:`Tencentcloud::mongodb::V20190725::ModifyInstanceAzRequest`
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::ModifyInstanceAzResponse`
        def ModifyInstanceAz(request)
          body = send_request('ModifyInstanceAz', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = ModifyInstanceAzResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @rtype: :class:`Tencentcloud::mongodb::V20190725::PromoteDBInstanceToActiveResponse`
        def PromoteDBInstanceToActive(request)
          body = send_request('PromoteDBInstanceToActive', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = PromoteDBInstanceToActiveResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
