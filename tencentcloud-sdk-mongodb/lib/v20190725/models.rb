  ...
  module Mongodb
    module V20190725
      ...
      class AuditLog < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :AffectRows, :Atype, :ExecTime, :Host, :Param, :Result, :Roles, :Timestamp, :User

        def initialize(affectrows=nil, atype=nil, exectime=nil, host=nil, param=nil, result=nil, roles=nil, timestamp=nil, user=nil)
      ...
      class DescribeAuditConfigResponse < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceId, :InstanceName, :AuditAll, :CreateTime, :LogExpireDay, :LogType, :IsClosing, :IsOpening, :RequestId

        def initialize(instanceid=nil, instancename=nil, auditall=nil, createtime=nil, logexpireday=nil, logtype=nil, isclosing=nil, isopening=nil, requestid=nil)
          @InstanceId = instanceid
          @InstanceName = instancename
          @AuditAll = auditall
          @CreateTime = createtime
      ...
      class DescribeAuditLogsRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceId, :StartTime, :EndTime, :Filter, :Limit, :Offset, :Order, :OrderBy

        def initialize(instanceid=nil, starttime=nil, endtime=nil, filter=nil, limit=nil, offset=nil, order=nil, orderby=nil)
          @InstanceId = instanceid
          @StartTime = starttime
          @EndTime = endtime
          @Filter = filter
      ...
      class DescribeDBInstanceNodePropertyResponse < TencentCloud::Common::AbstractModel
        ...
        # @type DynamoProxies: Array
        # @param RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        # @type RequestId: String

        attr_accessor :Mongos, :ReplicateSets, :DynamoProxies, :RequestId

        def initialize(mongos=nil, replicatesets=nil, dynamoproxies=nil, requestid=nil)
          @Mongos = mongos
          @ReplicateSets = replicatesets
          @DynamoProxies = dynamoproxies
          @RequestId = requestid
        end
        ...
        def deserialize(params)
          ...
          unless params['DynamoProxies'].nil?
            @DynamoProxies = []
            params['DynamoProxies'].each do |i|
              nodeproperty_tmp = NodeProperty.new
              nodeproperty_tmp.deserialize(i)
              @DynamoProxies << nodeproperty_tmp
            end
          end
          @RequestId = params['RequestId']
        end
      ...
      class InquirePriceCreateDBInstancesRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :Zone, :NodeNum, :Memory, :Volume, :MongoVersion, :MachineCode, :GoodsNum, :ClusterType, :ReplicateSetNum, :Period, :InstanceChargeType, :MongosCpu, :MongosMemory, :MongosNum, :ConfigServerCpu, :ConfigServerMemory, :ConfigServerVolume, :ReadonlyNodeNum, :Cpu

        def initialize(zone=nil, nodenum=nil, memory=nil, volume=nil, mongoversion=nil, machinecode=nil, goodsnum=nil, clustertype=nil, replicatesetnum=nil, period=nil, instancechargetype=nil, mongoscpu=nil, mongosmemory=nil, mongosnum=nil, configservercpu=nil, configservermemory=nil, configservervolume=nil, readonlynodenum=nil, cpu=nil)
          @Zone = zone
          @NodeNum = nodenum
          @Memory = memory
          @Volume = volume
      ...
      class InquirePriceModifyDBInstanceSpecRequest < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :InstanceId, :Memory, :Volume, :NodeNum, :ReplicateSetNum, :Cpu

        def initialize(instanceid=nil, memory=nil, volume=nil, nodenum=nil, replicatesetnum=nil, cpu=nil)
          @InstanceId = instanceid
          @Memory = memory
          @Volume = volume
          @NodeNum = nodenum
      ...
      class ModifyDBInstanceSpecRequest < TencentCloud::Common::AbstractModel
        ...
        deprecate :OplogSize, :none, 2026, 9
        deprecate :OplogSize=, :none, 2026, 9
