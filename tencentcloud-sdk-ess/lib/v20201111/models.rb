  ...
  module Ess
    module V20201111
      ...
      class ApproverOption < TencentCloud::Common::AbstractModel
        ...
        attr_accessor :NoRefuse, :NoTransfer, :CanEditApprover, :FillType, :FlowReadLimit, :ForbidAddSignDate, :ApproverMobileMode

        def initialize(norefuse=nil, notransfer=nil, caneditapprover=nil, filltype=nil, flowreadlimit=nil, forbidaddsigndate=nil, approvermobilemode=nil)
          @NoRefuse = norefuse
