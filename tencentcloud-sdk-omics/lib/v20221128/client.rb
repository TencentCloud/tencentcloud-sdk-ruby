  ...
  module Omics
    module V20221128
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::omics::V20221128::DeleteEnvironmentCacheRequest`
        # @rtype: :class:`Tencentcloud::omics::V20221128::DeleteEnvironmentCacheResponse`
        def DeleteEnvironmentCache(request)
          body = send_request('DeleteEnvironmentCache', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DeleteEnvironmentCacheResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::omics::V20221128::DescribePublicApplicationsRequest`
        # @rtype: :class:`Tencentcloud::omics::V20221128::DescribePublicApplicationsResponse`
        def DescribePublicApplications(request)
          body = send_request('DescribePublicApplications', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = DescribePublicApplicationsResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::omics::V20221128::GetRunJobLogRequest`
        # @rtype: :class:`Tencentcloud::omics::V20221128::GetRunJobLogResponse`
        def GetRunJobLog(request)
          body = send_request('GetRunJobLog', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = GetRunJobLogResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
