  ...
  module Tdmq
    module V20200217
      class Client < TencentCloud::Common::AbstractClient
        ...
        # @type request: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQGroupV2Request`
        # @rtype: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQGroupV2Response`
        def CreateRocketMQGroupV2(request)
          body = send_request('CreateRocketMQGroupV2', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateRocketMQGroupV2Response.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQMigrationTaskRequest`
        # @rtype: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQMigrationTaskResponse`
        def CreateRocketMQMigrationTask(request)
          body = send_request('CreateRocketMQMigrationTask', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateRocketMQMigrationTaskResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
        ...
        # @type request: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQRouterRuleRequest`
        # @rtype: :class:`Tencentcloud::tdmq::V20200217::CreateRocketMQRouterRuleResponse`
        def CreateRocketMQRouterRule(request)
          body = send_request('CreateRocketMQRouterRule', request.serialize)
          response = JSON.parse(body)
          if response['Response'].key?('Error') == false
            model = CreateRocketMQRouterRuleResponse.new
            model.deserialize(response['Response'])
            model
          else
            code = response['Response']['Error']['Code']
